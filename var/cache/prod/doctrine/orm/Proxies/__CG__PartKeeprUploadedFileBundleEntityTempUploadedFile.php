...
namespace Proxies\__CG__\PartKeepr\UploadedFileBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class TempUploadedFile extends \PartKeepr\UploadedFileBundle\Entity\TempUploadedFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TempUploadedFile $proxy) {
