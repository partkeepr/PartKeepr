 ...
 */
class ProjectAttachment extends \PartKeepr\ProjectBundle\Entity\ProjectAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ProjectAttachment' . "\0" . 'project'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectAttachment $proxy) {
