 ...
 */
class FootprintImage extends \PartKeepr\FootprintBundle\Entity\FootprintImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\FootprintBundle\\Entity\\FootprintImage' . "\0" . 'footprint'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FootprintImage $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setFootprint(\PartKeepr\FootprintBundle\Entity\Footprint $footprint)
    {
