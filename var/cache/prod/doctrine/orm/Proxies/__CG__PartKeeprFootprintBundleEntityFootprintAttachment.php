 ...
 */
class FootprintAttachment extends \PartKeepr\FootprintBundle\Entity\FootprintAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\FootprintBundle\\Entity\\FootprintAttachment' . "\0" . 'footprint'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FootprintAttachment $proxy) {
