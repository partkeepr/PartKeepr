...
class Footprint extends BaseEntity implements Serializable, Deserializable {
	 ...
	 * @ORM\ManyToOne(targetEntity="PartKeepr\FootprintBundle\Entity\FootprintCategory")
	 * @var Category 
	 */
	private $category;
	 ...
	 * @ORM\OneToOne(targetEntity="PartKeepr\FootprintBundle\Entity\FootprintImage",mappedBy="footprint",cascade={"persist", "remove"})
	 *
	 * @var FootprintImage
	 */
	private $image;
	 ...
	 * @ORM\OneToMany(targetEntity="PartKeepr\FootprintBundle\Entity\FootprintAttachment",mappedBy="footprint",cascade={"persist", "remove"})
	 *
	 ...
	 *
*@param \PartKeepr\FootprintBundle\Entity\FootprintCategory $category The category
	 */
