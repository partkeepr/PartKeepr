...
class OctoPartService
{
    ...
    public function getPartByUID ($uid) {
        ...
        $request->getQuery()->add("include", array("short_description", "datasheets", "compliance_documents", "descriptions", "imagesets", "specs", "reference_designs", "cad_models"));
    ...
    public function getPartyByQuery ($query, $start = 0) {
        ...
        $request->getQuery()->add("include", array("short_description"));
