 ...
 */
class ProjectRun extends \PartKeepr\ProjectBundle\Entity\ProjectRun implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ProjectRun' . "\0" . 'runDateTime', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ProjectRun' . "\0" . 'project', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ProjectRun' . "\0" . 'quantity', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ProjectRun' . "\0" . 'parts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectRun $proxy) {
    ...
    public function getRunDateTime()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRunDateTime', []);

        return parent::getRunDateTime();
    }
    ...
    public function setRunDateTime($runDateTime)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRunDateTime', [$runDateTime]);

        return parent::setRunDateTime($runDateTime);
    }
