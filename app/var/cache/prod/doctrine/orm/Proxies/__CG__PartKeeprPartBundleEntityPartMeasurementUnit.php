 ...
 */
class PartMeasurementUnit extends \PartKeepr\PartBundle\Entity\PartMeasurementUnit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\PartBundle\\Entity\\PartMeasurementUnit' . "\0" . 'name', '' . "\0" . 'PartKeepr\\PartBundle\\Entity\\PartMeasurementUnit' . "\0" . 'shortName', '' . "\0" . 'PartKeepr\\PartBundle\\Entity\\PartMeasurementUnit' . "\0" . 'default', '' . "\0" . 'PartKeepr\\PartBundle\\Entity\\PartMeasurementUnit' . "\0" . 'parts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartMeasurementUnit $proxy) {
