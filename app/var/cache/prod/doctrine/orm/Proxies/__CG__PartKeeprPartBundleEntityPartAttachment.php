 ...
 */
class PartAttachment extends \PartKeepr\PartBundle\Entity\PartAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\PartBundle\\Entity\\PartAttachment' . "\0" . 'isImage', '' . "\0" . 'PartKeepr\\PartBundle\\Entity\\PartAttachment' . "\0" . 'part'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartAttachment $proxy) {
