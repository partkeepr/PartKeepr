 ...
 */
class StorageLocationImage extends \PartKeepr\StorageLocationBundle\Entity\StorageLocationImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\StorageLocationBundle\\Entity\\StorageLocationImage' . "\0" . 'storageLocation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StorageLocationImage $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setStorageLocation(\PartKeepr\StorageLocationBundle\Entity\StorageLocation $storageLocation)
    {
