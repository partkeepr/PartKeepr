 ...
 */
class ManufacturerICLogo extends \PartKeepr\ManufacturerBundle\Entity\ManufacturerICLogo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\ManufacturerBundle\\Entity\\ManufacturerICLogo' . "\0" . 'manufacturer'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ManufacturerICLogo $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setManufacturer(\PartKeepr\ManufacturerBundle\Entity\Manufacturer $manufacturer = NULL)
    {
