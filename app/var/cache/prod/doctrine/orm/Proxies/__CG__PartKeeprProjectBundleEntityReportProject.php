 ...
 */
class ReportProject extends \PartKeepr\ProjectBundle\Entity\ReportProject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ReportProject' . "\0" . 'report', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ReportProject' . "\0" . 'project', '' . "\0" . 'PartKeepr\\ProjectBundle\\Entity\\ReportProject' . "\0" . 'quantity'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReportProject $proxy) {
