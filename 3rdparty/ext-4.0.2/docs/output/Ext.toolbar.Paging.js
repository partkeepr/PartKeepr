        ...
        "params": [
          {
            "type": "Mixed",
            "optional": false,
            "doc": "<p>The following types of arguments are all valid:<br /></p>\n\n<ul>\n<li><a href=\"#/api/Ext.button.Button\" rel=\"Ext.button.Button\" class=\"docClass\">Ext.button.Button</a> config: A valid button config object (equivalent to addButton)</li>\n<li>HtmlElement: Any standard HTML element (equivalent to addElement)</li>\n<li>Field: Any form field (equivalent to addField)</li>\n<li>Item: Any subclass of <a href=\"#/api/Ext.toolbar.Item\" rel=\"Ext.toolbar.Item\" class=\"docClass\">Ext.toolbar.Item</a> (equivalent to addItem)</li>\n<li>String: Any generic string (gets wrapped in a <a href=\"#/api/Ext.toolbar.TextItem\" rel=\"Ext.toolbar.TextItem\" class=\"docClass\">Ext.toolbar.TextItem</a>, equivalent to addText).\nNote that there are a few special strings that are treated differently as explained next.</li>\n<li>'-': Creates a separator element (equivalent to addSeparator)</li>\n<li>' ': Creates a spacer element (equivalent to addSpacer)</li>\n<li>'->': Creates a fill element (equivalent to addFill)</li>\n</ul>\n\n",
            "name": "arg1"
          },
          {
            "type": "Mixed",
