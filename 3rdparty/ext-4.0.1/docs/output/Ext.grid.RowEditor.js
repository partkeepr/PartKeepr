Ext.data.JsonP.Ext_grid_RowEditor({
  "tagname": "class",
  ...
  "cfg": [
    ...
    },
    {
      ...
      "type": "Mixed",
      "doc": "<p>A tag name or <a href=\"#/api/Ext.core.DomHelper\" rel=\"Ext.core.DomHelper\" class=\"docClass\">DomHelper</a> spec used to create the <a href=\"#/api/Ext.grid.RowEditor-method-getEl\" rel=\"Ext.grid.RowEditor-method-getEl\" class=\"docClass\">Element</a> which will\nencapsulate this Component.</p>\n\n\n<p>You do not normally need to specify this. For the base classes <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Ext.Component</a> and <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Ext.container.Container</a>,\nthis defaults to <b><tt>'div'</tt></b>. The more complex Sencha classes use a more complex\nDOM structure specified by their own <a href=\"#/api/Ext.grid.RowEditor-cfg-renderTpl\" rel=\"Ext.grid.RowEditor-cfg-renderTpl\" class=\"docClass\">renderTpl</a>s.</p>\n\n\n<p>This is intended to allow the developer to create application-specific utility Components encapsulated by\ndifferent DOM elements. Example usage:</p>\n\n\n<pre><code>{\n    xtype: 'component',\n    autoEl: {\n        tag: 'img',\n        src: 'http://www.example.com/example.jpg'\n    }\n}, {\n    xtype: 'component',\n    autoEl: {\n        tag: 'blockquote',\n        html: 'autoEl is cool!'\n    }\n}, {\n    xtype: 'container',\n    autoEl: 'ul',\n    cls: 'ux-unordered-list',\n    items: {\n        xtype: 'component',\n        autoEl: 'li',\n        html: 'First list item'\n    }\n}\n</code></pre>\n\n",
      "private": false,
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "type": "Mixed",
      "doc": "<p>This config is intended mainly for <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Components which may or may not be shown. Instead\nof using <a href=\"#/api/Ext.grid.RowEditor-cfg-renderTo\" rel=\"Ext.grid.RowEditor-cfg-renderTo\" class=\"docClass\">renderTo</a> in the configuration, and rendering upon construction, this allows a Component\nto render itself upon first <i><a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a></i>.</p>\n\n\n<p>Specify as <code>true</code> to have this Component render to the document body upon first show.</p>\n\n\n<p>Specify as an element, or the ID of an element to have this Component render to a specific element upon first show.</p>\n\n\n<p><b>This defaults to <code>true</code> for the <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Window</a> class.</b></p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/AbstractComponent.js",
      "linenr": 478,
      "html_filename": "AbstractComponent.html",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "type": "Boolean",
      "doc": "<p>True to automatically show the component upon creation.\nThis config option may only be used for <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> components or components\nthat use <a href=\"#/api/Ext.grid.RowEditor-cfg-autoRender\" rel=\"Ext.grid.RowEditor-cfg-autoRender\" class=\"docClass\">autoRender</a>. Defaults to <tt>false</tt>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/AbstractComponent.js",
      "linenr": 471,
      "html_filename": "AbstractComponent.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.AbstractPanel",
      "type": "Boolean",
      "doc": "<p>A shortcut to add or remove the border on the body of a panel. This only applies to a panel which has the <a href=\"#/api/Ext.grid.RowEditor-cfg-frame\" rel=\"Ext.grid.RowEditor-cfg-frame\" class=\"docClass\">frame</a> configuration set to <code>true</code>.\nDefaults to <code>undefined</code>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/panel/AbstractPanel.js",
      "linenr": 32,
      "html_filename": "AbstractPanel.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Object/Array",
      "doc": "<p>Convenience method used for adding buttons docked to the bottom right of the panel. This is a\nsynonym for the <a href=\"#/api/Ext.grid.RowEditor-cfg-fbar\" rel=\"Ext.grid.RowEditor-cfg-fbar\" class=\"docClass\">fbar</a> config.</p>\n\n<pre><code>buttons: [\n  { text: 'Button 1' }\n]\n</code></pre>\n\n<p>is equivalent to</p>\n\n<pre><code>dockedItems: [{\n    xtype: 'toolbar',\n    dock: 'bottom',\n    defaults: {minWidth: <a href=\"#/api/Ext.grid.RowEditor-cfg-minButtonWidth\" rel=\"Ext.grid.RowEditor-cfg-minButtonWidth\" class=\"docClass\">minButtonWidth</a>},\n    items: [\n        { xtype: 'component', flex: 1 },\n        { xtype: 'button', text: 'Button 1' }\n    ]\n}]\n</code></pre>\n\n<p>The <a href=\"#/api/Ext.grid.RowEditor-cfg-minButtonWidth\" rel=\"Ext.grid.RowEditor-cfg-minButtonWidth\" class=\"docClass\">minButtonWidth</a> is used as the default <a href=\"#/api/Ext.button.Button-cfg-minWidth\" rel=\"Ext.button.Button-cfg-minWidth\" class=\"docClass\">minWidth</a> for\neach of the buttons in the buttons toolbar.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 509,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "String",
      "doc": "<p>The action to take when the close header tool is clicked:\n<div class=\"mdetail-params\"><ul>\n<li><b><code>'<a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>'</code></b> : <b>Default</b><div class=\"sub-desc\">\n<a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">remove</a> the window from the DOM and <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>\nit and all descendant Components. The window will <b>not</b> be available to be\nredisplayed via the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n<li><b><code>'<a href=\"#/api/Ext.grid.RowEditor-event-hide\" rel=\"Ext.grid.RowEditor-event-hide\" class=\"docClass\">hide</a>'</code></b> : <div class=\"sub-desc\">\n<a href=\"#/api/Ext.grid.RowEditor-event-hide\" rel=\"Ext.grid.RowEditor-event-hide\" class=\"docClass\">hide</a> the window by setting visibility to hidden and applying negative offsets.\nThe window will be available to be redisplayed via the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n</ul></div>\n<p><b>Note:</b> This behavior has changed! setting *does* affect the <a href=\"#/api/Ext.grid.RowEditor-method-close\" rel=\"Ext.grid.RowEditor-method-close\" class=\"docClass\">close</a> method\nwhich will invoke the approriate closeAction.\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 223,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Boolean",
      "doc": "<p>The direction to collapse the Panel when the toggle button is clicked.</p>\n\n\n<p>Defaults to the <a href=\"#/api/Ext.grid.RowEditor-cfg-headerPosition\" rel=\"Ext.grid.RowEditor-cfg-headerPosition\" class=\"docClass\">headerPosition</a></p>\n\n\n<p><b>Important: This config is <u>ignored</u> for <a href=\"#/api/Ext.grid.RowEditor-cfg-collapsible\" rel=\"Ext.grid.RowEditor-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p>Specify as <code>'top'</code>, <code>'bottom'</code>, <code>'left'</code> or <code>'right'</code>.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 203,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Boolean",
      "doc": "<p>True to make the panel collapsible and have an expand/collapse toggle Tool added into\nthe header tool button area. False to keep the panel sized either statically, or by an owning layout manager, with no toggle Tool (defaults to false).</p>\n\n\n<p>See <a href=\"#/api/Ext.grid.RowEditor-cfg-collapseMode\" rel=\"Ext.grid.RowEditor-cfg-collapseMode\" class=\"docClass\">collapseMode</a> and <a href=\"#/api/Ext.grid.RowEditor-cfg-collapseDirection\" rel=\"Ext.grid.RowEditor-cfg-collapseDirection\" class=\"docClass\">collapseDirection</a></p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 195,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "type": "Mixed",
      "doc": "<p>The initial set of data to apply to the <code><a href=\"#/api/Ext.grid.RowEditor-cfg-tpl\" rel=\"Ext.grid.RowEditor-cfg-tpl\" class=\"docClass\">tpl</a></code> to\nupdate the content area of the Component.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/AbstractComponent.js",
      "linenr": 239,
      "html_filename": "AbstractComponent.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Boolean",
      "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.grid.RowEditor-cfg-collapsible\" rel=\"Ext.grid.RowEditor-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p><tt>true</tt> to allow clicking a collapsed Panel&#39;s <a href=\"#/api/Ext.grid.RowEditor-cfg-placeholder\" rel=\"Ext.grid.RowEditor-cfg-placeholder\" class=\"docClass\">placeholder</a> to display the Panel floated\nabove the layout, <tt>false</tt> to force the user to fully expand a collapsed region by\nclicking the expand button to see it again (defaults to <tt>true</tt>).</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 180,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.Component",
      "type": "Boolean",
      "doc": "<p>Specify as true to float the Component outside of the document flow using CSS absolute positioning.</p>\n\n\n<p>Components such as <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Window</a>s and <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">Menu</a>s are floating\nby default.</p>\n\n\n<p>Floating Components that are programatically <a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a> will register themselves with the global\n<a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a></p>\n\n\n<h3 class=\"pa\">Floating Components as child items of a Container</h3>\n\n\n<p>A floating Component may be used as a child item of a Container. This just allows the floating Component to seek a ZIndexManager by\nexamining the ownerCt chain.</p>\n\n\n<p>When configured as floating, Components acquire, at render time, a <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> which manages a stack\nof related floating Components. The ZIndexManager brings a single floating Component to the top of its stack when\nthe Component's <a href=\"#/api/Ext.grid.RowEditor-method-toFront\" rel=\"Ext.grid.RowEditor-method-toFront\" class=\"docClass\">toFront</a> method is called.</p>\n\n\n<p>The ZIndexManager is found by traversing up the <a href=\"#/api/Ext.grid.RowEditor-property-ownerCt\" rel=\"Ext.grid.RowEditor-property-ownerCt\" class=\"docClass\">ownerCt</a> chain to find an ancestor which itself is floating. This is so that\ndescendant floating Components of floating <i>Containers</i> (Such as a ComboBox dropdown within a Window) can have its zIndex managed relative\nto any siblings, but always <b>above</b> that floating ancestor Container.</p>\n\n\n<p>If no floating ancestor is found, a floating Component registers itself with the default <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a>.</p>\n\n\n<p>Floating components <i>do not participate in the Container's layout</i>. Because of this, they are not rendered until you explicitly\n<a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> them.</p>\n\n\n<p>After rendering, the ownerCt reference is deleted, and the <a href=\"#/api/Ext.grid.RowEditor-property-floatParent\" rel=\"Ext.grid.RowEditor-property-floatParent\" class=\"docClass\">floatParent</a> property is set to the found floating ancestor Container.\nIf no floating ancestor Container was found the <a href=\"#/api/Ext.grid.RowEditor-property-floatParent\" rel=\"Ext.grid.RowEditor-property-floatParent\" class=\"docClass\">floatParent</a> property will not be set.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/Component.js",
      "linenr": 175,
      "html_filename": "Component.html",
    ...
    },
    {
      ...
      "type": "Boolean",
      "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.grid.RowEditor-method-focus\" rel=\"Ext.grid.RowEditor-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.grid.RowEditor-method-toFront\" rel=\"Ext.grid.RowEditor-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
      "private": false,
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Boolean",
      "doc": "<p><code>true</code> to hide the expand/collapse toggle button when <code><a href=\"#/api/Ext.grid.RowEditor-cfg-collapsible\" rel=\"Ext.grid.RowEditor-cfg-collapsible\" class=\"docClass\">collapsible</a> == true</code>,\n<code>false</code> to display it (defaults to <code>false</code>).</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 143,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "type": "String/Object",
      "doc": "<p>An HTML fragment, or a <a href=\"#/api/Ext.core.DomHelper\" rel=\"Ext.core.DomHelper\" class=\"docClass\">DomHelper</a> specification to use as the layout element\ncontent (defaults to ''). The HTML content is added after the component is rendered,\nso the document will not contain this HTML at the time the <a href=\"#/api/Ext.grid.RowEditor-event-render\" rel=\"Ext.grid.RowEditor-event-render\" class=\"docClass\">render</a> event is fired.\nThis content is inserted into the body <i>before</i> any configured <a href=\"#/api/Ext.grid.RowEditor-cfg-contentEl\" rel=\"Ext.grid.RowEditor-cfg-contentEl\" class=\"docClass\">contentEl</a> is appended.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/AbstractComponent.js",
      "linenr": 419,
      "html_filename": "AbstractComponent.html",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "type": "String",
      "doc": "<p>The <b><u>unique id of this component instance</u></b> (defaults to an <a href=\"#/api/Ext.grid.RowEditor-method-getId\" rel=\"Ext.grid.RowEditor-method-getId\" class=\"docClass\">auto-assigned id</a>).</p>\n\n\n<p>It should not be necessary to use this configuration except for singleton objects in your application.\nComponents created with an id may be accessed globally using <a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">Ext.getCmp</a>.</p>\n\n\n<p>Instead of using assigned ids, use the <a href=\"#/api/Ext.grid.RowEditor-cfg-itemId\" rel=\"Ext.grid.RowEditor-cfg-itemId\" class=\"docClass\">itemId</a> config, and <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> which\nprovides selector-based searching for Sencha Components analogous to DOM querying. The <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Container</a>\nclass contains <a href=\"#/api/Ext.container.Container-method-down\" rel=\"Ext.container.Container-method-down\" class=\"docClass\">shortcut methods</a> to query its descendant Components by selector.</p>\n\n\n<p>Note that this id will also be used as the element id for the containing HTML element\nthat is rendered to the page for this component. This allows you to write id-based CSS\nrules to style the specific instance of this component uniquely, and also to select\nsub-elements using this component's id as the parent.</p>\n\n\n<p><b>Note</b>: to avoid complications imposed by a unique <tt>id</tt> also see <code><a href=\"#/api/Ext.grid.RowEditor-cfg-itemId\" rel=\"Ext.grid.RowEditor-cfg-itemId\" class=\"docClass\">itemId</a></code>.</p>\n\n\n<p><b>Note</b>: to access the container of a Component see <code><a href=\"#/api/Ext.grid.RowEditor-property-ownerCt\" rel=\"Ext.grid.RowEditor-property-ownerCt\" class=\"docClass\">ownerCt</a></code>.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/AbstractComponent.js",
      "linenr": 50,
      "html_filename": "AbstractComponent.html",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "type": "String",
      "doc": "<p>An <tt>itemId</tt> can be used as an alternative way to get a reference to a component\nwhen no object reference is available.  Instead of using an <code><a href=\"#/api/Ext.grid.RowEditor-cfg-id\" rel=\"Ext.grid.RowEditor-cfg-id\" class=\"docClass\">id</a></code> with\n<a href=\"#/api/Ext\" rel=\"Ext\" class=\"docClass\">Ext</a>.<a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">getCmp</a>, use <code>itemId</code> with\n<a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Ext.container.Container</a>.<a href=\"#/api/Ext.container.Container-method-getComponent\" rel=\"Ext.container.Container-method-getComponent\" class=\"docClass\">getComponent</a> which will retrieve\n<code>itemId</code>'s or <tt><a href=\"#/api/Ext.grid.RowEditor-cfg-id\" rel=\"Ext.grid.RowEditor-cfg-id\" class=\"docClass\">id</a></tt>'s. Since <code>itemId</code>'s are an index to the\ncontainer's internal MixedCollection, the <code>itemId</code> is scoped locally to the container --\navoiding potential conflicts with <a href=\"#/api/Ext.ComponentManager\" rel=\"Ext.ComponentManager\" class=\"docClass\">Ext.ComponentManager</a> which requires a <b>unique</b>\n<code><a href=\"#/api/Ext.grid.RowEditor-cfg-id\" rel=\"Ext.grid.RowEditor-cfg-id\" class=\"docClass\">id</a></code>.</p>\n\n\n<pre><code>var c = new Ext.panel.Panel({ //\n    <a href=\"#/api/Ext.Component-cfg-height\" rel=\"Ext.Component-cfg-height\" class=\"docClass\">height</a>: 300,\n    <a href=\"#/api/Ext.grid.RowEditor-cfg-renderTo\" rel=\"Ext.grid.RowEditor-cfg-renderTo\" class=\"docClass\">renderTo</a>: document.body,\n    <a href=\"#/api/Ext.container.Container-cfg-layout\" rel=\"Ext.container.Container-cfg-layout\" class=\"docClass\">layout</a>: 'auto',\n    <a href=\"#/api/Ext.container.Container-property-items\" rel=\"Ext.container.Container-property-items\" class=\"docClass\">items</a>: [\n        {\n            itemId: 'p1',\n            <a href=\"#/api/Ext.panel.Panel--title\" rel=\"Ext.panel.Panel--title\" class=\"docClass\">title</a>: 'Panel 1',\n            <a href=\"#/api/Ext.Component-cfg-height\" rel=\"Ext.Component-cfg-height\" class=\"docClass\">height</a>: 150\n        },\n        {\n            itemId: 'p2',\n            <a href=\"#/api/Ext.panel.Panel--title\" rel=\"Ext.panel.Panel--title\" class=\"docClass\">title</a>: 'Panel 2',\n            <a href=\"#/api/Ext.Component-cfg-height\" rel=\"Ext.Component-cfg-height\" class=\"docClass\">height</a>: 150\n        }\n    ]\n})\np1 = c.<a href=\"#/api/Ext.container.Container-method-getComponent\" rel=\"Ext.container.Container-method-getComponent\" class=\"docClass\">getComponent</a>('p1'); // not the same as <a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">Ext.getCmp()</a>\np2 = p1.<a href=\"#/api/Ext.grid.RowEditor-property-ownerCt\" rel=\"Ext.grid.RowEditor-property-ownerCt\" class=\"docClass\">ownerCt</a>.<a href=\"#/api/Ext.container.Container-method-getComponent\" rel=\"Ext.container.Container-method-getComponent\" class=\"docClass\">getComponent</a>('p2'); // reference via a sibling\n</code></pre>\n\n\n<p>Also see <tt><a href=\"#/api/Ext.grid.RowEditor-cfg-id\" rel=\"Ext.grid.RowEditor-cfg-id\" class=\"docClass\">id</a></tt>, <code><a href=\"#/api/Ext.grid.RowEditor-method-query\" rel=\"Ext.grid.RowEditor-method-query\" class=\"docClass\">query</a></code>, <code><a href=\"#/api/Ext.grid.RowEditor-method-down\" rel=\"Ext.grid.RowEditor-method-down\" class=\"docClass\">down</a></code> and <code><a href=\"#/api/Ext.grid.RowEditor-method-child\" rel=\"Ext.grid.RowEditor-method-child\" class=\"docClass\">child</a></code>.</p>\n\n\n<p><b>Note</b>: to access the container of an item see <tt><a href=\"#/api/Ext.grid.RowEditor-property-ownerCt\" rel=\"Ext.grid.RowEditor-property-ownerCt\" class=\"docClass\">ownerCt</a></tt>.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/AbstractComponent.js",
      "linenr": 66,
      "html_filename": "AbstractComponent.html",
    ...
    },
    {
      ...
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/form/Panel.js",
      "linenr": 152,
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Mixed",
      "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.grid.RowEditor-cfg-collapsible\" rel=\"Ext.grid.RowEditor-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>\nwhen not using the <code>'header'</code> <a href=\"#/api/Ext.grid.RowEditor-cfg-collapseMode\" rel=\"Ext.grid.RowEditor-cfg-collapseMode\" class=\"docClass\">collapseMode</a>.</b></p>\n\n\n<p><b>Optional.</b> A Component (or config object for a Component) to show in place of this Panel when this Panel is collapsed by a\n<a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>. Defaults to a generated <a href=\"#/api/Ext.panel.Header\" rel=\"Ext.panel.Header\" class=\"docClass\">Header</a>\ncontaining a <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Tool</a> to re-expand the Panel.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 171,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.form.Panel",
      "type": "Number",
      "doc": "<p>Interval in milliseconds at which the form's fields are checked for value changes. Only used if\nthe <a href=\"#/api/Ext.grid.RowEditor-cfg-pollForChanges\" rel=\"Ext.grid.RowEditor-cfg-pollForChanges\" class=\"docClass\">pollForChanges</a> option is set to <tt>true</tt>. Defaults to 500 milliseconds.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/form/Panel.js",
      "linenr": 146,
      "html_filename": "Panel.html",
      "href": "Panel.html#Ext-form-Panel-cfg-pollInterval",
      "shortDoc": "Interval in milliseconds at which the form's fields are checked for value changes. Only used if\nthe pollForChanges op..."
    },
    {
      "tagname": "cfg",
      "name": "preventHeader",
    ...
    },
    {
      ...
      "member": "Ext.state.Stateful",
      "type": "Array",
      "doc": "<p>An array of events that, when fired, should trigger this object to\nsave its state (defaults to none). <code>stateEvents</code> may be any type\nof event supported by this object, including browser or custom events\n(e.g., <tt>['click', 'customerchange']</tt>).</p>\n\n\n<p>See <code><a href=\"#/api/Ext.grid.RowEditor-cfg-stateful\" rel=\"Ext.grid.RowEditor-cfg-stateful\" class=\"docClass\">stateful</a></code> for an explanation of saving and\nrestoring object state.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/state/Stateful.js",
      "linenr": 64,
      "html_filename": "Stateful.html",
    ...
    },
    {
      ...
      "member": "Ext.state.Stateful",
      "type": "String",
      "doc": "<p>The unique id for this object to use for state management purposes.</p>\n\n<p>See <a href=\"#/api/Ext.grid.RowEditor-cfg-stateful\" rel=\"Ext.grid.RowEditor-cfg-stateful\" class=\"docClass\">stateful</a> for an explanation of saving and restoring state.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/state/Stateful.js",
      "linenr": 58,
      "html_filename": "Stateful.html",
    ...
    },
    {
      ...
      "member": "Ext.state.Stateful",
      "type": "Boolean",
      "doc": "<p>A flag which causes the object to attempt to restore the state of\ninternal properties from a saved state on startup. The object must have\na <code><a href=\"#/api/Ext.grid.RowEditor-cfg-stateId\" rel=\"Ext.grid.RowEditor-cfg-stateId\" class=\"docClass\">stateId</a></code> for state to be managed. \nAuto-generated ids are not guaranteed to be stable across page loads and \ncannot be relied upon to save and restore the same state for a object.<p>\n<p>For state saving to work, the state manager's provider must have been\nset to an implementation of <a href=\"#/api/Ext.state.Provider\" rel=\"Ext.state.Provider\" class=\"docClass\">Ext.state.Provider</a> which overrides the\n<a href=\"#/api/Ext.state.Provider-method-set\" rel=\"Ext.state.Provider-method-set\" class=\"docClass\">set</a> and <a href=\"#/api/Ext.state.Provider-method-get\" rel=\"Ext.state.Provider-method-get\" class=\"docClass\">get</a>\nmethods to save and recall name/value pairs. A built-in implementation,\n<a href=\"#/api/Ext.state.CookieProvider\" rel=\"Ext.state.CookieProvider\" class=\"docClass\">Ext.state.CookieProvider</a> is available.</p>\n<p>To set the state provider for the current page:</p>\n<pre><code>Ext.state.Manager.setProvider(new Ext.state.CookieProvider({\n    expires: new Date(new Date().getTime()+(1000*60*60*24*7)), //7 days from now\n}));\n</code></pre>\n<p>A stateful object attempts to save state when one of the events\nlisted in the <code><a href=\"#/api/Ext.grid.RowEditor-cfg-stateEvents\" rel=\"Ext.grid.RowEditor-cfg-stateEvents\" class=\"docClass\">stateEvents</a></code> configuration fires.</p>\n<p>To save state, a stateful object first serializes its state by\ncalling <b><code><a href=\"#/api/Ext.grid.RowEditor-method-getState\" rel=\"Ext.grid.RowEditor-method-getState\" class=\"docClass\">getState</a></code></b>. By default, this function does\nnothing. The developer must provide an implementation which returns an\nobject hash which represents the restorable state of the object.</p>\n<p>The value yielded by getState is passed to <a href=\"#/api/Ext.state.Manager-method-set\" rel=\"Ext.state.Manager-method-set\" class=\"docClass\">Ext.state.Manager.set</a>\nwhich uses the configured <a href=\"#/api/Ext.state.Provider\" rel=\"Ext.state.Provider\" class=\"docClass\">Ext.state.Provider</a> to save the object\nkeyed by the <code><a href=\"#/api/stateId\" rel=\"stateId\" class=\"docClass\">stateId</a></code></p>.\n<p>During construction, a stateful object attempts to <i>restore</i>\nits state by calling <a href=\"#/api/Ext.state.Manager-method-get\" rel=\"Ext.state.Manager-method-get\" class=\"docClass\">Ext.state.Manager.get</a> passing the\n<code><a href=\"#/api/Ext.grid.RowEditor-cfg-stateId\" rel=\"Ext.grid.RowEditor-cfg-stateId\" class=\"docClass\">stateId</a></code></p>\n<p>The resulting object is passed to <b><code><a href=\"#/api/Ext.grid.RowEditor-method-applyState\" rel=\"Ext.grid.RowEditor-method-applyState\" class=\"docClass\">applyState</a></code></b>.\nThe default implementation of <code><a href=\"#/api/Ext.grid.RowEditor-method-applyState\" rel=\"Ext.grid.RowEditor-method-applyState\" class=\"docClass\">applyState</a></code> simply copies\nproperties into the object, but a developer may override this to support\nmore behaviour.</p>\n<p>You can perform extra processing on state save and restore by attaching\nhandlers to the <a href=\"#/api/Ext.grid.RowEditor-event-beforestaterestore\" rel=\"Ext.grid.RowEditor-event-beforestaterestore\" class=\"docClass\">beforestaterestore</a>, <a href=\"#/api/Ext.grid.RowEditor-event-staterestore\" rel=\"Ext.grid.RowEditor-event-staterestore\" class=\"docClass\">staterestore</a>,\n<a href=\"#/api/Ext.grid.RowEditor-event-beforestatesave\" rel=\"Ext.grid.RowEditor-event-beforestatesave\" class=\"docClass\">beforestatesave</a> and <a href=\"#/api/Ext.grid.RowEditor-event-statesave\" rel=\"Ext.grid.RowEditor-event-statesave\" class=\"docClass\">statesave</a> events.</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/state/Stateful.js",
      "linenr": 18,
      "html_filename": "Stateful.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Boolean",
      "doc": "<p><code>true</code> to allow expanding and collapsing the panel (when <code><a href=\"#/api/Ext.grid.RowEditor-cfg-collapsible\" rel=\"Ext.grid.RowEditor-cfg-collapsible\" class=\"docClass\">collapsible</a> = true</code>)\nby clicking anywhere in the header bar, <code>false</code>) to allow it only by clicking to tool button\n(defaults to <code>false</code>)).</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 150,
      "html_filename": "Panel3.html",
    ...
    },
    {
      ...
      "member": "Ext.Component",
      "type": "Boolean",
      "doc": "<p>True to automatically call <a href=\"#/api/Ext.grid.RowEditor-method-toFront\" rel=\"Ext.grid.RowEditor-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/Component.js",
      "linenr": 199,
      "html_filename": "Component.html",
    ...
    },
    {
      ...
      "member": "Ext.panel.Panel",
      "type": "Array",
      "doc": "<p>An array of <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Ext.panel.Tool</a> configs/instances to be added to the header tool area. The tools are stored as child\ncomponents of the header container. They can be accessed using <a href=\"#/api/Ext.grid.RowEditor-method-down\" rel=\"Ext.grid.RowEditor-method-down\" class=\"docClass\">down</a> and {#query}, as well as the other\ncomponent methods. The toggle tool is automatically created if <a href=\"#/api/Ext.grid.RowEditor-cfg-collapsible\" rel=\"Ext.grid.RowEditor-cfg-collapsible\" class=\"docClass\">collapsible</a> is set to true.</p>\n\n<p>Note that, apart from the toggle tool which is provided when a panel is collapsible, these\ntools only provide the visual button. Any required functionality must be provided by adding\nhandlers that implement the necessary behavior.</p>\n\n\n<p>Example usage:</p>\n\n\n<pre><code>tools:[{\n    type:'refresh',\n    qtip: 'Refresh form Data',\n    // hidden:true,\n    handler: function(event, toolEl, panel){\n        // refresh logic\n    }\n},\n{\n    type:'help',\n    qtip: 'Get Help',\n    handler: function(event, toolEl, panel){\n        // show help here\n    }\n}]\n</code></pre>\n\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 281,
      "html_filename": "Panel3.html",
  ...
  "method": [
    {
      ...
      "linenr": 1,
      "html_filename": "Panel.html",
      "href": "Panel.html#Ext-form-Panel-method-constructor",
      "shortDoc": "\n"
    },
    {
      "tagname": "method",
      "name": "add",
      "member": "Ext.container.AbstractContainer",
      "doc": "<p>Adds <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Component</a>(s) to this Container.</p>\n\n<h2>Description:</h2>\n\n<ul>\n<li>Fires the <a href=\"#/api/Ext.grid.RowEditor-event-beforeadd\" rel=\"Ext.grid.RowEditor-event-beforeadd\" class=\"docClass\">beforeadd</a> event before adding.</li>\n<li>The Container's <a href=\"#/api/Ext.grid.RowEditor-cfg-defaults\" rel=\"Ext.grid.RowEditor-cfg-defaults\" class=\"docClass\">default config values</a> will be applied\naccordingly (see <code><a href=\"#/api/Ext.grid.RowEditor-cfg-defaults\" rel=\"Ext.grid.RowEditor-cfg-defaults\" class=\"docClass\">defaults</a></code> for details).</li>\n<li>Fires the <code><a href=\"#/api/Ext.grid.RowEditor-event-add\" rel=\"Ext.grid.RowEditor-event-add\" class=\"docClass\">add</a></code> event after the component has been added.</li>\n</ul>\n\n\n<h2>Notes:</h2>\n\n<p>If the Container is <strong>already rendered</strong> when <code>add</code>\nis called, it will render the newly added Component into its content area.</p>\n\n<p><strong><strong>If</strong></strong> the Container was configured with a size-managing <a href=\"#/api/Ext.grid.RowEditor-cfg-layout\" rel=\"Ext.grid.RowEditor-cfg-layout\" class=\"docClass\">layout</a> manager, the Container\nwill recalculate its internal layout at this time too.</p>\n\n<p>Note that the default layout manager simply renders child Components sequentially into the content area and thereafter performs no sizing.</p>\n\n<p>If adding multiple new child Components, pass them as an array to the <code>add</code> method, so that only one layout recalculation is performed.</p>\n\n<pre><code>tb = new <a href=\"#/api/Ext.toolbar.Toolbar\" rel=\"Ext.toolbar.Toolbar\" class=\"docClass\">Ext.toolbar.Toolbar</a>({\n    renderTo: document.body\n});  // toolbar is rendered\ntb.add([{text:'Button 1'}, {text:'Button 2'}]); // add multiple items. (<a href=\"#/api/Ext.grid.RowEditor-cfg-defaultType\" rel=\"Ext.grid.RowEditor-cfg-defaultType\" class=\"docClass\">defaultType</a> for <a href=\"#/api/Ext.toolbar.Toolbar\" rel=\"Ext.toolbar.Toolbar\" class=\"docClass\">Toolbar</a> is 'button')\n</code></pre>\n\n<h2>Warning:##</h2>\n\n<p>Components directly managed by the BorderLayout layout manager\nmay not be removed or added.  See the Notes for <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">BorderLayout</a>\nfor more details.</p>\n",
      "params": [
        {
          "type": "...Object/Array",
          "name": "Component",
          "doc": "<p>Either one or more Components to add or an Array of Components to add.\nSee <code><a href=\"#/api/Ext.grid.RowEditor-property-items\" rel=\"Ext.grid.RowEditor-property-items\" class=\"docClass\">items</a></code> for additional information.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "addClass",
      "member": "Ext.AbstractComponent",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.RowEditor-method-addCls\" rel=\"Ext.grid.RowEditor-method-addCls\" class=\"docClass\">addCls</a>\nAdds a CSS class to the top level element representing this component.</p>\n",
      "params": [
        {
          "type": "String",
          "name": "cls",
      ...
      "shortDoc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.RowEditor-method-addCls\" rel=\"Ext.grid.RowEditor-method-addCls\" class=\"docClass\">addCls</a>\nAdds a CSS class to the top level element representing this component.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addCls",
    ...
    },
    {
      ...
      "name": "addClsWithUI",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.RowEditor--addUIClsToElement\" rel=\"Ext.grid.RowEditor--addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
      ...
      "shortDoc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.RowEditor--addUIClsToElement\" rel=\"Ext.grid.RowEditor--addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addDocked",
    ...
    },
    {
      ...
      "shortDoc": "<p>Forces each field within the form panel to\n<a href=\"#/api/Ext.form.field.Field-method-checkChange\" rel=\"Ext.form.field.Field-method-checkChange\" class=\"docClass\">check if its value has changed</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "child",
    ...
    },
    {
      ...
      "name": "close",
      "member": "Ext.panel.Panel",
      "doc": "<p>Closes the Panel. By default, this method, removes it from the DOM, <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>s\nthe Panel object and all its descendant Components. The <a href=\"#/api/Ext.grid.RowEditor--beforeclose\" rel=\"Ext.grid.RowEditor--beforeclose\" class=\"docClass\">beforeclose</a>\nevent is fired before the close happens and will cancel the close action if it returns false.<p>\n<p><b>Note:</b> This method is not affected by the <a href=\"#/api/Ext.grid.RowEditor-cfg-closeAction\" rel=\"Ext.grid.RowEditor-cfg-closeAction\" class=\"docClass\">closeAction</a> setting which\nonly affects the action triggered when clicking the <a href=\"#/api/Ext.grid.RowEditor-cfg-closable\" rel=\"Ext.grid.RowEditor-cfg-closable\" class=\"docClass\">'close' tool in the header</a>.\nTo hide the Panel without destroying it, call <a href=\"#/api/Ext.grid.RowEditor-event-hide\" rel=\"Ext.grid.RowEditor-event-hide\" class=\"docClass\">hide</a>.</p>\n\n",
      "params": [
    ...
    },
    {
      ...
      "name": "collapse",
      "member": "Ext.panel.Panel",
      "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the\nborder towards which the collapse takes place will remain visible.  Fires the <a href=\"#/api/Ext.grid.RowEditor--beforecollapse\" rel=\"Ext.grid.RowEditor--beforecollapse\" class=\"docClass\">beforecollapse</a> event which will\ncancel the collapse action if it returns false.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "direction",
        ...
        },
        {
          "type": "Boolean",
          "name": "animate",
          "doc": "<p>True to animate the transition, else false (defaults to the value of the\n<a href=\"#/api/Ext.grid.RowEditor-cfg-animCollapse\" rel=\"Ext.grid.RowEditor-cfg-animCollapse\" class=\"docClass\">animCollapse</a> panel config)</p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "name": "expand",
      "member": "Ext.panel.Panel",
      "doc": "<p>Expands the panel body so that it becomes visible.  Fires the <a href=\"#/api/Ext.grid.RowEditor--beforeexpand\" rel=\"Ext.grid.RowEditor--beforeexpand\" class=\"docClass\">beforeexpand</a> event which will\ncancel the expand action if it returns false.</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "animate",
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.grid.RowEditor-method-enableBubble\" rel=\"Ext.grid.RowEditor-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "member": "Ext.panel.AbstractPanel",
      "doc": "<p>Finds a docked component by id, itemId or position. Also see <a href=\"#/api/Ext.grid.RowEditor-method-getDockedItems\" rel=\"Ext.grid.RowEditor-method-getDockedItems\" class=\"docClass\">getDockedItems</a></p>\n",
      "params": [
        {
          "type": "String/Number",
          "name": "comp",
          "doc": "<p>The id, itemId or position of the docked component (see <a href=\"#/api/Ext.grid.RowEditor-method-getComponent\" rel=\"Ext.grid.RowEditor-method-getComponent\" class=\"docClass\">getComponent</a> for details)</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Finds a docked component by id, itemId or position. Also see <a href=\"#/api/Ext.grid.RowEditor-method-getDockedItems\" rel=\"Ext.grid.RowEditor-method-getDockedItems\" class=\"docClass\">getDockedItems</a></p>\n"
    },
    {
      "tagname": "method",
      "name": "getDockedItems",
    ...
    },
    {
      ...
      "shortDoc": "<p>Provides access to the <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">Form</a> which this Panel contains.</p>\n"
    },
    {
      "tagname": "method",
      "name": "getHeight",
    ...
    },
    {
      ...
      "name": "getRecord",
      "member": "Ext.form.Panel",
      "doc": "<p>Returns the currently loaded <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> instance if one was loaded via <a href=\"#/api/Ext.grid.RowEditor-method-loadRecord\" rel=\"Ext.grid.RowEditor-method-loadRecord\" class=\"docClass\">loadRecord</a>.</p>\n",
      "params": [
      ...
      "shortDoc": "<p>Returns the currently loaded <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> instance if one was loaded via <a href=\"#/api/Ext.grid.RowEditor-method-loadRecord\" rel=\"Ext.grid.RowEditor-method-loadRecord\" class=\"docClass\">loadRecord</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "getSize",
    ...
    },
    {
      ...
      "shortDoc": "Convenience function for fetching the current value of each field in the form. This is the same as calling\nthis.getFo..."
    },
    {
      "tagname": "method",
      "name": "getWidth",
    ...
    },
    {
      ...
      "name": "hasActiveFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.RowEditor-method-getActiveAnimation\" rel=\"Ext.grid.RowEditor-method-getActiveAnimation\" class=\"docClass\">getActiveAnimation</a>\nReturns thq current animation if this object has any effects actively running or queued, else returns false.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "hide",
      "member": "Ext.Component",
      "doc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.grid.RowEditor-cfg-hideMode\" rel=\"Ext.grid.RowEditor-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n",
      "params": [
        {
          "type": "String/Element/Component",
          "name": "animateTarget",
          "doc": "<p>Optional, and <b>only valid for <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Components such as\n<a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Window</a>s or <a href=\"#/api/Ext.tip.ToolTip\" rel=\"Ext.tip.ToolTip\" class=\"docClass\">ToolTip</a>s, or regular Components which have been configured\nwith <code>floating: true</code>.</b>.\nThe target to which the Component should animate while hiding (defaults to null with no animation)</p>\n",
          "optional": false
        },
        {
          "type": "Function",
      ...
      "shortDoc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.grid.RowEditor-cfg-hideMode\" rel=\"Ext.grid.RowEditor-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "insert",
      "member": "Ext.container.AbstractContainer",
      "doc": "<p>Inserts a Component into this Container at a specified index. Fires the\n<a href=\"#/api/Ext.grid.RowEditor-event-beforeadd\" rel=\"Ext.grid.RowEditor-event-beforeadd\" class=\"docClass\">beforeadd</a> event before inserting, then fires the <a href=\"#/api/Ext.grid.RowEditor-event-add\" rel=\"Ext.grid.RowEditor-event-add\" class=\"docClass\">add</a> event after the\nComponent has been inserted.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "index",
    ...
    },
    {
      ...
      "shortDoc": "<p>This is a proxy for the underlying BasicForm's <a href=\"#/api/Ext.form.Basic-method-load\" rel=\"Ext.form.Basic-method-load\" class=\"docClass\">Ext.form.Basic.load</a> call.</p>\n"
    },
    {
      "tagname": "method",
      "name": "loadRecord",
      "member": "Ext.form.Panel",
      "doc": "<p>Loads an <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> into this form (internally just calls <a href=\"#/api/Ext.form.Basic-method-loadRecord\" rel=\"Ext.form.Basic-method-loadRecord\" class=\"docClass\">Ext.form.Basic.loadRecord</a>)\nSee also <a href=\"#/api/Ext.grid.RowEditor--trackResetOnLoad\" rel=\"Ext.grid.RowEditor--trackResetOnLoad\" class=\"docClass\">trackResetOnLoad</a>.</p>\n",
      "params": [
        {
          "type": "Ext.data.Model",
          "name": "record",
      ...
      "shortDoc": "<p>Loads an <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> into this form (internally just calls <a href=\"#/api/Ext.form.Basic-method-loadRecord\" rel=\"Ext.form.Basic-method-loadRecord\" class=\"docClass\">Ext.form.Basic.loadRecord</a>)\nSee also <a href=\"#/api/Ext.grid.RowEditor--trackResetOnLoad\" rel=\"Ext.grid.RowEditor--trackResetOnLoad\" class=\"docClass\">trackResetOnLoad</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "move",
    ...
    },
    {
      ...
      "name": "nextNode",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Returns the next node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree to attempt to find a match. Contrast with <a href=\"#/api/Ext.grid.RowEditor--pnextSibling\" rel=\"Ext.grid.RowEditor--pnextSibling\" class=\"docClass\">pnextSibling</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "selector",
    ...
    },
    {
      ...
      "name": "nextSibling",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Returns the next sibling of this Component.</p>\n\n\n<p>Optionally selects the next sibling which matches the passed <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> selector.</p>\n\n\n<p>May also be refered to as <code><b>next()</b></code></p>\n\n\n<p>Note that this is limited to siblings, and if no siblings of the item match, <code>null</code> is returned. Contrast with <a href=\"#/api/Ext.grid.RowEditor-method-nextNode\" rel=\"Ext.grid.RowEditor-method-nextNode\" class=\"docClass\">nextNode</a></p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "selector",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.grid.RowEditor-method-addListener\" rel=\"Ext.grid.RowEditor-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.RowEditor-method-addListener\" rel=\"Ext.grid.RowEditor-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.RowEditor-method-addListener\" rel=\"Ext.grid.RowEditor-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "previousNode",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Returns the previous node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree in reverse order to attempt to find a match. Contrast with <a href=\"#/api/Ext.grid.RowEditor-method-previousSibling\" rel=\"Ext.grid.RowEditor-method-previousSibling\" class=\"docClass\">previousSibling</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "selector",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "doc": "<p>Returns the previous sibling of this Component.</p>\n\n\n<p>Optionally selects the previous sibling which matches the passed <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> selector.</p>\n\n\n<p>May also be refered to as <code><b>prev()</b></code></p>\n\n\n<p>Note that this is limited to siblings, and if no siblings of the item match, <code>null</code> is returned. Contrast with <a href=\"#/api/Ext.grid.RowEditor-method-previousNode\" rel=\"Ext.grid.RowEditor-method-previousNode\" class=\"docClass\">previousNode</a></p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "selector",
    ...
    },
    {
      ...
      "name": "remove",
      "member": "Ext.container.AbstractContainer",
      "doc": "<p>Removes a component from this container.  Fires the <a href=\"#/api/Ext.grid.RowEditor-event-beforeremove\" rel=\"Ext.grid.RowEditor-event-beforeremove\" class=\"docClass\">beforeremove</a> event before removing, then fires\nthe <a href=\"#/api/Ext.grid.RowEditor-event-remove\" rel=\"Ext.grid.RowEditor-event-remove\" class=\"docClass\">remove</a> event after the component has been removed.</p>\n",
      "params": [
        {
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "doc": "<p>Removes a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.RowEditor--removeUIClsToElement\" rel=\"Ext.grid.RowEditor--removeUIClsToElement\" class=\"docClass\">removeUIClsToElement</a> and removes\nit from all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.grid.RowEditor-method-addListener\" rel=\"Ext.grid.RowEditor-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.RowEditor--mon\" rel=\"Ext.grid.RowEditor--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.RowEditor--mon\" rel=\"Ext.grid.RowEditor--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.grid.RowEditor-method-suspendEvents\" rel=\"Ext.grid.RowEditor-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "sequenceFx",
      "member": "Ext.util.Animate",
      "doc": "<p>Ensures that all effects queued after sequenceFx is called on this object are\nrun in sequence.  This is the opposite of <a href=\"#/api/Ext.grid.RowEditor-method-syncFx\" rel=\"Ext.grid.RowEditor-method-syncFx\" class=\"docClass\">syncFx</a>.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "setHeight",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.grid.RowEditor-event-resize\" rel=\"Ext.grid.RowEditor-event-resize\" class=\"docClass\">resize</a> event.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "height",
          "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.grid.RowEditor-method-getEl\" rel=\"Ext.grid.RowEditor-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.grid.RowEditor-event-resize\" rel=\"Ext.grid.RowEditor-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "setIconCls",
    ...
    },
    {
      ...
      "member": "Ext.Component",
      "doc": "<p>Sets the page XY position of the component.  To set the left and top instead, use <a href=\"#/api/Ext.grid.RowEditor-method-setPosition\" rel=\"Ext.grid.RowEditor-method-setPosition\" class=\"docClass\">setPosition</a>.\nThis method fires the <a href=\"#/api/Ext.grid.RowEditor-event-move\" rel=\"Ext.grid.RowEditor-event-move\" class=\"docClass\">move</a> event.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "x",
    ...
    },
    {
      ...
      "name": "setPosition",
      "member": "Ext.Component",
      "doc": "<p>Sets the left and top of the component.  To set the page XY position instead, use <a href=\"#/api/Ext.grid.RowEditor-method-setPagePosition\" rel=\"Ext.grid.RowEditor-method-setPagePosition\" class=\"docClass\">setPagePosition</a>.\nThis method fires the <a href=\"#/api/Ext.grid.RowEditor-event-move\" rel=\"Ext.grid.RowEditor-event-move\" class=\"docClass\">move</a> event.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "left",
    ...
    },
    {
      ...
      "name": "setSize",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Sets the width and height of this Component. This method fires the <a href=\"#/api/Ext.grid.RowEditor-event-resize\" rel=\"Ext.grid.RowEditor-event-resize\" class=\"docClass\">resize</a> event. This method can accept\neither width and height as separate arguments, or you can pass a size object like <code>{width:10, height:20}</code>.</p>\n",
      "params": [
        {
          "type": "Mixed",
          "name": "width",
          "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.grid.RowEditor-method-getEl\" rel=\"Ext.grid.RowEditor-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n",
          "optional": false
        },
        {
          "type": "Mixed",
    ...
    },
    {
      ...
      "name": "setWidth",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.grid.RowEditor-event-resize\" rel=\"Ext.grid.RowEditor-event-resize\" class=\"docClass\">resize</a> event.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "width",
      ...
      "shortDoc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.grid.RowEditor-event-resize\" rel=\"Ext.grid.RowEditor-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "show",
      "member": "Ext.Component",
      "doc": "<p>Shows this Component, rendering it first if <a href=\"#/api/Ext.grid.RowEditor-cfg-autoRender\" rel=\"Ext.grid.RowEditor-cfg-autoRender\" class=\"docClass\">autoRender</a> or {<a href=\"#/api/\"floating\" rel=\"\"floating\" class=\"docClass\">&quot;floating</a> are <code>true</code>.</p>\n\n\n<p>After being shown, a <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Component (such as a <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Ext.window.Window</a>), is activated it and brought to the front of\nits <a href=\"#/api/Ext.grid.RowEditor--ZIndexManager\" rel=\"Ext.grid.RowEditor--ZIndexManager\" class=\"docClass\">z-index stack</a>.</p>\n\n",
      "params": [
        {
          "type": "String/Element",
          "name": "animateTarget",
    ...
    },
    {
      "tagname": "method",
      "name": "startEdit",
      "member": "Ext.grid.RowEditor",
      "doc": "<p>Start editing the specified grid at the specified position.</p>\n",
      "params": [
        {
          "type": "Model",
          "name": "record",
        ...
        },
        {
          "type": "Model",
          "name": "columnHeader",
          "doc": "<p>The Column object defining the column to be edited.</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/grid/RowEditor.js",
      "linenr": 493,
      "html_filename": "RowEditor.html",
      "href": "RowEditor.html#Ext-grid-RowEditor-method-startEdit",
      "shortDoc": "<p>Start editing the specified grid at the specified position.</p>\n"
    },
    {
      "tagname": "method",
      "name": "startPolling",
      "member": "Ext.form.Panel",
      "doc": "<p>Start an interval task to continuously poll all the fields in the form for changes in their\nvalues. This is normally started automatically by setting the <a href=\"#/api/Ext.grid.RowEditor-cfg-pollForChanges\" rel=\"Ext.grid.RowEditor-cfg-pollForChanges\" class=\"docClass\">pollForChanges</a> config.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "interval",
    ...
    },
    {
      ...
      "name": "stopFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.RowEditor-method-stopAnimation\" rel=\"Ext.grid.RowEditor-method-stopAnimation\" class=\"docClass\">stopAnimation</a>\nStops any running effects and clears this object's internal effects queue if it contains\nany additional effects that haven't started yet.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "stopPolling",
      "member": "Ext.form.Panel",
      "doc": "<p>Stop a running interval task that was started by <a href=\"#/api/Ext.grid.RowEditor-method-startPolling\" rel=\"Ext.grid.RowEditor-method-startPolling\" class=\"docClass\">startPolling</a>.</p>\n",
      "params": [
      ...
      "shortDoc": "<p>Stop a running interval task that was started by <a href=\"#/api/Ext.grid.RowEditor-method-startPolling\" rel=\"Ext.grid.RowEditor-method-startPolling\" class=\"docClass\">startPolling</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "submit",
      ...
      "shortDoc": "<p>This is a proxy for the underlying BasicForm's <a href=\"#/api/Ext.form.Basic-method-submit\" rel=\"Ext.form.Basic-method-submit\" class=\"docClass\">Ext.form.Basic.submit</a> call.</p>\n"
    },
    {
      "tagname": "method",
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.RowEditor-method-resumeEvents\" rel=\"Ext.grid.RowEditor-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
          "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.grid.RowEditor-method-resumeEvents\" rel=\"Ext.grid.RowEditor-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events;</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.RowEditor-method-resumeEvents\" rel=\"Ext.grid.RowEditor-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "syncFx",
      "member": "Ext.util.Animate",
      "doc": "<p>Ensures that all effects queued after syncFx is called on this object are\nrun concurrently.  This is the opposite of <a href=\"#/api/Ext.grid.RowEditor-method-sequenceFx\" rel=\"Ext.grid.RowEditor-method-sequenceFx\" class=\"docClass\">sequenceFx</a>.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "toggleCollapse",
      "member": "Ext.panel.Panel",
      "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.grid.RowEditor-method-expand\" rel=\"Ext.grid.RowEditor-method-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.grid.RowEditor-method-collapse\" rel=\"Ext.grid.RowEditor-method-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
      "params": [
      ...
      "shortDoc": "<p>Shortcut for performing an <a href=\"#/api/Ext.grid.RowEditor-method-expand\" rel=\"Ext.grid.RowEditor-method-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.grid.RowEditor-method-collapse\" rel=\"Ext.grid.RowEditor-method-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.RowEditor-method-removeListener\" rel=\"Ext.grid.RowEditor-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.RowEditor-method-removeListener\" rel=\"Ext.grid.RowEditor-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "up",
  ...
  "property": [
    {
      ...
      "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.grid.RowEditor-property-draggable\" rel=\"Ext.grid.RowEditor-property-draggable\" class=\"docClass\">draggable</a>, this property will contain\nan instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a>\nin order to supply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.grid.RowEditor-property-draggable\" rel=\"Ext.grid.RowEditor-property-draggable\" class=\"docClass\">draggable</a>.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/panel/Panel.js",
      "linenr": 1336,
    ...
    },
    {
      ...
      "member": "Ext.Component",
      "type": "Ext.Container",
      "doc": "<p>Optional. Only present for <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Components which were inserted as descendant items of floating Containers.</p>\n\n\n<p>Floating Components that are programatically <a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a> will not have a <code>floatParent</code> property.</p>\n\n\n<p>For <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Components which are child items of a Container, the floatParent will be the floating ancestor Container which is\nresponsible for the base z-index value of all its floating descendants. It provides a <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> which provides\nz-indexing services for all its descendant floating Components.</p>\n\n\n<p>For example, the dropdown <a href=\"#/api/Ext.view.BoundList\" rel=\"Ext.view.BoundList\" class=\"docClass\">BoundList</a> of a ComboBox which is in a Window will have the Window as its\n<code>floatParent</code></p>\n\n\n<p>See <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> and <a href=\"#/api/Ext.grid.RowEditor-property-zIndexManager\" rel=\"Ext.grid.RowEditor-property-zIndexManager\" class=\"docClass\">zIndexManager</a></p>\n\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/Component.js",
      "linenr": 221,
    ...
    },
    {
      ...
      "doc": "<p>Optional. Only present for <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Components after they have been rendered.</p>\n\n\n<p>A reference to the ZIndexManager which is managing this Component's z-index.</p>\n\n\n<p>The <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> maintains a stack of floating Component z-indices, and also provides a single modal\nmask which is insert just beneath the topmost visible modal floating Component.</p>\n\n\n<p>Floating Components may be <a href=\"#/api/Ext.grid.RowEditor-method-toFront\" rel=\"Ext.grid.RowEditor-method-toFront\" class=\"docClass\">brought to the front</a> or <a href=\"#/api/Ext.grid.RowEditor-method-toBack\" rel=\"Ext.grid.RowEditor-method-toBack\" class=\"docClass\">sent to the back</a> of the z-index stack.</p>\n\n\n<p>This defaults to the global <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a> for floating Components that are programatically\n<a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a>.</p>\n\n\n<p>For <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> Components which are added to a Container, the ZIndexManager is acquired from the first ancestor Container found\nwhich is floating, or if not found the global <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a> is used.</p>\n\n\n<p>See <a href=\"#/api/Ext.grid.RowEditor-cfg-floating\" rel=\"Ext.grid.RowEditor-cfg-floating\" class=\"docClass\">floating</a> and <a href=\"#/api/Ext.grid.RowEditor-property-floatParent\" rel=\"Ext.grid.RowEditor-property-floatParent\" class=\"docClass\">floatParent</a></p>\n\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/Component.js",
      "linenr": 206,
  ...
  "event": [
    ...
    },
    {
      ...
      "name": "afterrender",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires after the component rendering is finished.</p>\n\n\n<p>The afterrender event is fired after this Component has been <a href=\"#/api/Ext.grid.RowEditor-property-rendered\" rel=\"Ext.grid.RowEditor-property-rendered\" class=\"docClass\">rendered</a>, been postprocesed\nby any afterRender method defined for the Component.</p>\n\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
    ...
    },
    {
      ...
      "name": "beforedestroy",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforehide",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.grid.RowEditor-event-hide\" rel=\"Ext.grid.RowEditor-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.grid.RowEditor-event-hide\" rel=\"Ext.grid.RowEditor-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeremove",
    ...
    },
    {
      ...
      "name": "beforerender",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.RowEditor-property-rendered\" rel=\"Ext.grid.RowEditor-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.grid.RowEditor-event-render\" rel=\"Ext.grid.RowEditor-event-render\" class=\"docClass\">render</a>.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.RowEditor-property-rendered\" rel=\"Ext.grid.RowEditor-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.grid.RowEditor-event-render\" rel=\"Ext.grid.RowEditor-event-render\" class=\"docClass\">render</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeshow",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
    },
    {
      "tagname": "event",
    ...
    },
    {
      ...
      "name": "destroy",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires after the component is <a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires after the component is <a href=\"#/api/Ext.grid.RowEditor-event-destroy\" rel=\"Ext.grid.RowEditor-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
    },
    {
      "tagname": "event",
      "name": "disable",
    ...
    },
    {
      ...
      "name": "hide",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.grid.RowEditor-event-hide\" rel=\"Ext.grid.RowEditor-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
    ...
    },
    {
      ...
      "name": "render",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires after the component markup is <a href=\"#/api/Ext.grid.RowEditor-property-rendered\" rel=\"Ext.grid.RowEditor-property-rendered\" class=\"docClass\">rendered</a>.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires after the component markup is <a href=\"#/api/Ext.grid.RowEditor-property-rendered\" rel=\"Ext.grid.RowEditor-property-rendered\" class=\"docClass\">rendered</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "resize",
    ...
    },
    {
      ...
      "name": "show",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method.</p>\n",
      "params": [
        {
          "type": "Ext.Component",
          "name": "this",
      ...
      "shortDoc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.grid.RowEditor-event-show\" rel=\"Ext.grid.RowEditor-event-show\" class=\"docClass\">show</a> method.</p>\n"
    },
    {
      "tagname": "event",
      "name": "staterestore",
  ...
  "linenr": 9,
  "html_filename": "RowEditor.html",
  "href": "RowEditor.html#Ext-grid-RowEditor",
  "cssVar": [
