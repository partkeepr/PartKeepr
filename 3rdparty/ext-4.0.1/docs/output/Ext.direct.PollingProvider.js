  ...
  "cfg": [
    {
      "tagname": "cfg",
      "name": "baseParams",
      "member": "Ext.direct.PollingProvider",
      "type": "Object",
      "doc": "<p>An object containing properties which are to be sent as parameters\non every polling request</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/direct/PollingProvider.js",
      "linenr": 53,
    ...
    },
    {
      ...
      "shortDoc": "The url which the PollingProvider should contact with each request. This can also be\nan imported Ext.Direct method wh..."
    }
  ],
  "method": [
    {
    ...
    },
    {
      ...
      "shortDoc": "<p>Connect to the server-side and begin the polling process. To handle each\nresponse subscribe to the data event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "createEvent",
    ...
    },
    {
      ...
      "shortDoc": "Disconnect from the server-side and stop the polling process. The disconnect\nevent will be fired on a successful disc..."
    },
    {
      "tagname": "method",
      "name": "enableBubble",
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.direct.PollingProvider-method-addListener\" rel=\"Ext.direct.PollingProvider-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.direct.PollingProvider-method-addListener\" rel=\"Ext.direct.PollingProvider-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.direct.PollingProvider-method-addListener\" rel=\"Ext.direct.PollingProvider-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.direct.PollingProvider--mon\" rel=\"Ext.direct.PollingProvider--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.direct.PollingProvider--mon\" rel=\"Ext.direct.PollingProvider--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.direct.PollingProvider-method-suspendEvents\" rel=\"Ext.direct.PollingProvider-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.direct.PollingProvider-method-resumeEvents\" rel=\"Ext.direct.PollingProvider-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.direct.PollingProvider-method-resumeEvents\" rel=\"Ext.direct.PollingProvider-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.direct.PollingProvider-method-removeListener\" rel=\"Ext.direct.PollingProvider-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.direct.PollingProvider-method-removeListener\" rel=\"Ext.direct.PollingProvider-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
  ...
  "event": [
    {
      ...
      "shortDoc": "<p>Fired immediately before a poll takes place, an event handler can return false\nin order to cancel the poll.</p>\n"
    },
    {
      "tagname": "event",
      "name": "connect",
    ...
    },
    {
      ...
      "shortDoc": "<p>This event has not yet been implemented.</p>\n"
    }
  ],
  "filename": "/Users/nick/Projects/sencha/SDK/platform/src/direct/PollingProvider.js",
  "linenr": 1,
