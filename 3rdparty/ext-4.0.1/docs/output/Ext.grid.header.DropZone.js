Ext.data.JsonP.Ext_grid_header_DropZone({
  "tagname": "class",
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "notifyDrop",
      "member": "Ext.dd.DropZone",
      "doc": "<p>The function a <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> calls once to notify this drop zone that the dragged item has\nbeen dropped on it.  The drag zone will look up the target node based on the event passed in, and if there\nis a node registered for that event, it will delegate to <a href=\"#/api/Ext.grid.header.DropZone-method-onNodeDrop\" rel=\"Ext.grid.header.DropZone-method-onNodeDrop\" class=\"docClass\">onNodeDrop</a> for node-specific handling,\notherwise it will call <a href=\"#/api/Ext.grid.header.DropZone-method-onContainerDrop\" rel=\"Ext.grid.header.DropZone-method-onContainerDrop\" class=\"docClass\">onContainerDrop</a>.</p>\n",
      "params": [
        {
    ...
    },
    {
      ...
      "name": "notifyOut",
      "member": "Ext.dd.DropZone",
      "doc": "<p>The function a <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> calls once to notify this drop zone that the source has been dragged\nout of the zone without dropping.  If the drag source is currently over a registered node, the notification\nwill be delegated to <a href=\"#/api/Ext.grid.header.DropZone-method-onNodeOut\" rel=\"Ext.grid.header.DropZone-method-onNodeOut\" class=\"docClass\">onNodeOut</a> for node-specific handling, otherwise it will be ignored.</p>\n",
      "params": [
        {
          "type": "Ext.dd.DragSource",
          "name": "source",
    ...
    },
    {
      ...
      "name": "notifyOver",
      "member": "Ext.dd.DropZone",
      "doc": "<p>The function a <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> calls continuously while it is being dragged over the drop zone.\nThis method will be called on every mouse movement while the drag source is over the drop zone.\nIt will call <a href=\"#/api/Ext.grid.header.DropZone-method-onNodeOver\" rel=\"Ext.grid.header.DropZone-method-onNodeOver\" class=\"docClass\">onNodeOver</a> while the drag source is over a registered node, and will also automatically\ndelegate to the appropriate node-specific methods as necessary when the drag source enters and exits\nregistered nodes (<a href=\"#/api/Ext.grid.header.DropZone-method-onNodeEnter\" rel=\"Ext.grid.header.DropZone-method-onNodeEnter\" class=\"docClass\">onNodeEnter</a>, <a href=\"#/api/Ext.grid.header.DropZone-method-onNodeOut\" rel=\"Ext.grid.header.DropZone-method-onNodeOut\" class=\"docClass\">onNodeOut</a>). If the drag source is not currently over a\nregistered node, it will call <a href=\"#/api/Ext.grid.header.DropZone-method-onContainerOver\" rel=\"Ext.grid.header.DropZone-method-onContainerOver\" class=\"docClass\">onContainerOver</a>.</p>\n",
      "params": [
        {
          "type": "Ext.dd.DragSource",
          "name": "source",
      ...
      "params": [
        {
          "type": "Object",
          "name": "nodeData",
          "doc": "<p>The custom data associated with the drop node (this is the same value returned from\n<a href=\"#/api/Ext.grid.header.DropZone-method-getTargetFromEvent\" rel=\"Ext.grid.header.DropZone-method-getTargetFromEvent\" class=\"docClass\">getTargetFromEvent</a> for this node)</p>\n",
          "optional": false
        },
        {
          "type": "Ext.dd.DragSource",
  ...
  "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/grid/header/DropZone.js",
  "linenr": 1,
  "html_filename": "DropZone2.html",
  "href": "DropZone2.html#Ext-grid-header-DropZone",
  "cssVar": [
