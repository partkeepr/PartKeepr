Ext.data.JsonP.Ext_tab_Panel({
  "tagname": "class",
  "name": "Ext.tab.Panel",
  "doc": "<p>A basic tab container. TabPanels can be used exactly like a standard <a href=\"#/api/Ext.panel.Panel\" rel=\"Ext.panel.Panel\" class=\"docClass\">Ext.panel.Panel</a> for layout purposes, but also\nhave special support for containing child Components (<code><a href=\"#/api/Ext.container.Container-property-items\" rel=\"Ext.container.Container-property-items\" class=\"docClass\">items</a></code>) that are managed\nusing a <a href=\"#/api/Ext.layout.container.Card\" rel=\"Ext.layout.container.Card\" class=\"docClass\">CardLayout layout manager</a>, and displayed as separate tabs.</p>\n\n<p><strong>Note:</strong></p>\n\n<p>By default, a tab's close tool <em>destroys</em> the child tab Component and all its descendants. This makes the child tab\nComponent, and all its descendants <strong>unusable</strong>. To enable re-use of a tab, configure the TabPanel with <code><a href=\"#/api/Ext.tab.Panel-cfg-autoDestroy\" rel=\"Ext.tab.Panel-cfg-autoDestroy\" class=\"docClass\">autoDestroy: false</a></code>.</p>\n\n<p><strong>TabPanel's layout:</strong></p>\n\n<p>TabPanels use a Dock layout to position the <a href=\"#/api/Ext.tab.Bar\" rel=\"Ext.tab.Bar\" class=\"docClass\">TabBar</a> at the top of the widget. Panels added to the TabPanel will have their\nheader hidden by default because the Tab will automatically take the Panel's configured title and icon.</p>\n\n<p>TabPanels use their <a href=\"#/api/Ext.panel.Panel--header\" rel=\"Ext.panel.Panel--header\" class=\"docClass\">header</a> or <a href=\"#/api/Ext.panel.Panel--footer\" rel=\"Ext.panel.Panel--footer\" class=\"docClass\">footer</a> element (depending on the <a href=\"#/api/Ext.tab.Panel-cfg-tabPosition\" rel=\"Ext.tab.Panel-cfg-tabPosition\" class=\"docClass\">tabPosition</a>\nconfiguration) to accommodate the tab selector buttons. This means that a TabPanel will not display any configured title, and will not display any\nconfigured header <a href=\"#/api/Ext.panel.Panel-cfg-tools\" rel=\"Ext.panel.Panel-cfg-tools\" class=\"docClass\">tools</a>.</p>\n\n<p>To display a header, embed the TabPanel in a <a href=\"#/api/Ext.panel.Panel\" rel=\"Ext.panel.Panel\" class=\"docClass\">Panel</a> which uses <code><a href=\"#/api/Ext.container.Container-cfg-layout\" rel=\"Ext.container.Container-cfg-layout\" class=\"docClass\">layout:'fit'</a></code>.</p>\n\n<p><strong>Examples:</strong></p>\n\n<p>Here is a basic TabPanel rendered to the body. This also shows the useful configuration <a href=\"#/api/Ext.tab.Panel--activeTab\" rel=\"Ext.tab.Panel--activeTab\" class=\"docClass\">activeTab</a>, which allows you to set the active tab on render.\nIf you do not set an <a href=\"#/api/Ext.tab.Panel--activeTab\" rel=\"Ext.tab.Panel--activeTab\" class=\"docClass\">activeTab</a>, no tabs will be active by default.\n<p><img src=\"doc-resources/Ext.tab.Panel/Ext.tab.Panel1.png\" alt=\"TabPanel component\"></p>\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.tab.Panel', {\n    width: 300,\n    height: 200,\n    activeTab: 0,\n    items: [\n        {\n            title: 'Tab 1',\n            bodyPadding: 10,\n            html : 'A simple tab'\n        },\n        {\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()\n}); \n</code></pre>\n\n<p>It is easy to control the visibility of items in the tab bar. Specify hidden: true to have the\ntab button hidden initially. Items can be subsequently hidden and show by accessing the\ntab property on the child item.</p>\n\n<p>Example usage:</p>\n\n<pre><code>var tabs = Ext.create('Ext.tab.Panel', {\n    width: 400,\n    height: 400,\n    renderTo: document.body,\n    items: [{\n        title: 'Home',\n        html: 'Home',\n        itemId: 'home'\n    }, {\n        title: 'Users',\n        html: 'Users',\n        itemId: 'users',\n        hidden: true\n    }, {\n        title: 'Tickets',\n        html: 'Tickets',\n        itemId: 'tickets'\n    }]    \n});\n\nsetTimeout(function(){\n    tabs.child('#home').tab.hide();\n    var users = tabs.child('#users');\n    users.tab.show();\n    tabs.setActiveTab(users);\n}, 1000);\n</code></pre>\n\n<p>You can remove the background of the TabBar by setting the <a href=\"#/api/Ext.tab.Panel--plain\" rel=\"Ext.tab.Panel--plain\" class=\"docClass\">plain</a> property to <code>false</code>.</p>\n\n<p>Example usage:</p>\n\n<pre><code>Ext.create('Ext.tab.Panel', {\n    width: 300,\n    height: 200,\n    activeTab: 0,\n    plain: true,\n    items: [\n        {\n            title: 'Tab 1',\n            bodyPadding: 10,\n            html : 'A simple tab'\n        },\n        {\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()\n}); \n</code></pre>\n\n<p>Another useful configuration of TabPanel is <a href=\"#/api/Ext.tab.Panel-cfg-tabPosition\" rel=\"Ext.tab.Panel-cfg-tabPosition\" class=\"docClass\">tabPosition</a>. This allows you to change the position where the tabs are displayed. The available\noptions for this are <code>'top'</code> (default) and <code>'bottom'</code>.\n<p><img src=\"doc-resources/Ext.tab.Panel/Ext.tab.Panel2.png\" alt=\"TabPanel component\"></p>\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.tab.Panel', {\n    width: 300,\n    height: 200,\n    activeTab: 0,\n    bodyPadding: 10,        \n    tabPosition: 'bottom',\n    items: [\n        {\n            title: 'Tab 1',\n            html : 'A simple tab'\n        },\n        {\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()\n}); \n</code></pre>\n\n<p>The <a href=\"#/api/Ext.tab.Panel-method-setActiveTab\" rel=\"Ext.tab.Panel-method-setActiveTab\" class=\"docClass\">setActiveTab</a> is a very useful method in TabPanel which will allow you to change the current active tab. You can either give it an index or\nan instance of a tab.</p>\n\n<p>Example usage:</p>\n\n<pre><code>var tabs = Ext.create('Ext.tab.Panel', {\n    items: [\n        {\n            id   : 'my-tab',\n            title: 'Tab 1',\n            html : 'A simple tab'\n        },\n        {\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()\n});\n\nvar tab = Ext.getCmp('my-tab');\n\nExt.create('Ext.button.Button', {\n    renderTo: Ext.getBody(),\n    text    : 'Select the first tab',\n    scope   : this,\n    handler : function() {\n        tabs.setActiveTab(tab);\n    }\n});\n\nExt.create('Ext.button.Button', {\n    text    : 'Select the second tab',\n    scope   : this,\n    handler : function() {\n        tabs.setActiveTab(1);\n    },\n    renderTo : Ext.getBody()        \n});\n</code></pre>\n\n<p>The <a href=\"#/api/Ext.tab.Panel-method-getActiveTab\" rel=\"Ext.tab.Panel-method-getActiveTab\" class=\"docClass\">getActiveTab</a> is a another useful method in TabPanel which will return the current active tab.</p>\n\n<p>Example usage:</p>\n\n<pre><code>var tabs = Ext.create('Ext.tab.Panel', {\n    items: [\n        {\n            title: 'Tab 1',\n            html : 'A simple tab'\n        },\n        {\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()        \n});\n\nExt.create('Ext.button.Button', {\n    text    : 'Get active tab',\n    scope   : this,\n    handler : function() {\n        var tab = tabs.getActiveTab();\n        alert('Current tab: ' + tab.title);\n    },\n    renderTo : Ext.getBody()        \n});\n</code></pre>\n\n<p>Adding a new tab is very simple with a TabPanel. You simple call the <a href=\"#/api/Ext.tab.Panel-event-add\" rel=\"Ext.tab.Panel-event-add\" class=\"docClass\">add</a> method with an config object for a panel.</p>\n\n<p>Example usage:</p>\n\n<pre><code>var tabs = Ext.Create('Ext.tab.Panel', {\n    items: [\n        {\n            title: 'Tab 1',\n            html : 'A simple tab'\n        },\n        {\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()        \n});\n\nExt.create('Ext.button.Button', {\n    text    : 'New tab',\n    scope   : this,\n    handler : function() {\n        var tab = tabs.add({\n            title: 'Tab ' + (tabs.items.length + 1), //we use the tabs.items property to get the length of current items/tabs\n            html : 'Another one'\n        });\n\n        tabs.setActiveTab(tab);\n    },\n    renderTo : Ext.getBody()\n});\n</code></pre>\n\n<p>Additionally, removing a tab is very also simple with a TabPanel. You simple call the <a href=\"#/api/Ext.tab.Panel-event-remove\" rel=\"Ext.tab.Panel-event-remove\" class=\"docClass\">remove</a> method with an config object for a panel.</p>\n\n<p>Example usage:</p>\n\n<pre><code>var tabs = Ext.Create('Ext.tab.Panel', {        \n    items: [\n        {\n            title: 'Tab 1',\n            html : 'A simple tab'\n        },\n        {\n            id   : 'remove-this-tab',\n            title: 'Tab 2',\n            html : 'Another one'\n        }\n    ],\n    renderTo : Ext.getBody()\n});\n\nExt.Create('Ext.button.Button', {\n    text    : 'Remove tab',\n    scope   : this,\n    handler : function() {\n        var tab = Ext.getCmp('remove-this-tab');\n        tabs.remove(tab);\n    },\n    renderTo : Ext.getBody()\n});\n</code></pre>\n",
  ...
  "cfg": [
    {
      ...
      "type": "Boolean",
      "doc": "<p>plain\nTrue to not show the full background on the TabBar</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/tab/Panel.js",
      "linenr": 295,
      "html_filename": "Panel4.html",
      "href": "Panel4.html#Ext-tab-Panel-cfg-Boolean"
    },
    {
      "tagname": "cfg",
      "name": "activeItem",
    ...
    },
    {
      ...
      "member": "Ext.tab.Panel",
      "type": "Boolean",
      "doc": "<p><tt>true</tt> by default to defer the rendering of child <tt><a href=\"#/api/Ext.container.Container-property-items\" rel=\"Ext.container.Container-property-items\" class=\"docClass\">items</a></tt>\nto the browsers DOM until a tab is activated. <tt>false</tt> will render all contained\n<tt><a href=\"#/api/Ext.container.Container-property-items\" rel=\"Ext.container.Container-property-items\" class=\"docClass\">items</a></tt> as soon as the <a href=\"#/api/Ext.layout.container.Card\" rel=\"Ext.layout.container.Card\" class=\"docClass\">layout</a>\nis rendered. If there is a significant amount of content or a lot of heavy controls being\nrendered into panels that are not displayed by default, setting this to <tt>true</tt> might\nimprove performance.</p>\n\n\n<br><p>The <tt>deferredRender</tt> property is internally passed to the layout manager for\n\n\n<p>TabPanels (<a href=\"#/api/Ext.layout.container.Card\" rel=\"Ext.layout.container.Card\" class=\"docClass\">Ext.layout.container.Card</a>) as its <a href=\"#/api/Ext.layout.container.Card-cfg-deferredRender\" rel=\"Ext.layout.container.Card-cfg-deferredRender\" class=\"docClass\">Ext.layout.container.Card.deferredRender</a>\nconfiguration value.</p></p>\n\n<br><p><b>Note</b>: leaving <tt>deferredRender</tt> as <tt>true</tt> means that the content\n\n\n<p>within an unactivated tab will not be available</p></p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/tab/Panel.js",
      "linenr": 310,
      "html_filename": "Panel4.html",
      "href": "Panel4.html#Ext-tab-Panel-cfg-deferredRender",
      "shortDoc": "true by default to defer the rendering of child items\nto the browsers DOM until a tab is activated. false will render..."
    },
    {
      "tagname": "cfg",
      "name": "disabled",
    ...
    },
    {
      ...
      "type": "Boolean",
      "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.tab.Panel-method-focus\" rel=\"Ext.tab.Panel-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.tab.Panel-method-toFront\" rel=\"Ext.tab.Panel-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
      "private": false,
    ...
    },
    {
      ...
      "member": "Ext.tab.Panel",
      "type": "Number",
      "doc": "<p>The minimum width for a tab in the <a href=\"#/api/Ext.tab.Panel-property-tabBar\" rel=\"Ext.tab.Panel-property-tabBar\" class=\"docClass\">tabBar</a>. Defaults to <code>30</code>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/tab/Panel.js",
      "linenr": 306,
      "html_filename": "Panel4.html",
    ...
    },
    {
      ...
      "member": "Ext.tab.Panel",
      "type": "Boolean",
      "doc": "<p>True to instruct each Panel added to the TabContainer to not render its header\nelement. This is to ensure that the title of the panel does not appear twice. Defaults to true.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/tab/Panel.js",
      "linenr": 289,
      "html_filename": "Panel4.html",
      "href": "Panel4.html#Ext-tab-Panel-cfg-removePanelHeader",
      "shortDoc": "True to instruct each Panel added to the TabContainer to not render its header\nelement. This is to ensure that the ti..."
    },
    {
      "tagname": "cfg",
    ...
    },
    {
      ...
      "member": "Ext.tab.Panel",
      "type": "Object",
      "doc": "<p>Optional configuration object for the internal <a href=\"#/api/Ext.tab.Bar\" rel=\"Ext.tab.Bar\" class=\"docClass\">Ext.tab.Bar</a>. If present, this is\npassed straight through to the TabBar's constructor</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/tab/Panel.js",
      "linenr": 279,
      "html_filename": "Panel4.html",
      "href": "Panel4.html#Ext-tab-Panel-cfg-tabBar",
      "shortDoc": "Optional configuration object for the internal Ext.tab.Bar. If present, this is\npassed straight through to the TabBar..."
    },
    {
      "tagname": "cfg",
      "name": "tabPosition",
      ...
      "shortDoc": "The position where the tab strip should be rendered (defaults to 'top').\nIn 4.0, The only other supported value is 'b..."
    },
    {
      "tagname": "cfg",
      "name": "tbar",
  ...
  "method": [
    {
      ...
      "linenr": 1,
      "html_filename": "Panel4.html",
      "href": "Panel4.html#Ext-tab-Panel-method-constructor",
      "shortDoc": "\n"
    },
    {
      "tagname": "method",
    ...
    },
    {
      ...
      "name": "addClass",
      "member": "Ext.AbstractComponent",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.tab.Panel-method-addCls\" rel=\"Ext.tab.Panel-method-addCls\" class=\"docClass\">addCls</a>\nAdds a CSS class to the top level element representing this component.</p>\n",
      "params": [
        {
          "type": "String",
          "name": "cls",
      ...
      "shortDoc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.tab.Panel-method-addCls\" rel=\"Ext.tab.Panel-method-addCls\" class=\"docClass\">addCls</a>\nAdds a CSS class to the top level element representing this component.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addCls",
    ...
    },
    {
      ...
      "name": "addClsWithUI",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.tab.Panel--addUIClsToElement\" rel=\"Ext.tab.Panel--addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
      ...
      "shortDoc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.tab.Panel--addUIClsToElement\" rel=\"Ext.tab.Panel--addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addDocked",
    ...
    },
    {
      ...
      "name": "collapse",
      "member": "Ext.panel.Panel",
      "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the\nborder towards which the collapse takes place will remain visible.  Fires the <a href=\"#/api/Ext.tab.Panel--beforecollapse\" rel=\"Ext.tab.Panel--beforecollapse\" class=\"docClass\">beforecollapse</a> event which will\ncancel the collapse action if it returns false.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "direction",
    ...
    },
    {
      ...
      "name": "expand",
      "member": "Ext.panel.Panel",
      "doc": "<p>Expands the panel body so that it becomes visible.  Fires the <a href=\"#/api/Ext.tab.Panel--beforeexpand\" rel=\"Ext.tab.Panel--beforeexpand\" class=\"docClass\">beforeexpand</a> event which will\ncancel the expand action if it returns false.</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "animate",
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.tab.Panel-method-enableBubble\" rel=\"Ext.tab.Panel-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "name": "getActiveTab",
      "member": "Ext.tab.Panel",
      "doc": "<p>Returns the item that is currently active inside this TabPanel. Note that before the TabPanel first activates a\nchild component this will return whatever was configured in the <a href=\"#/api/Ext.tab.Panel--activeTab\" rel=\"Ext.tab.Panel--activeTab\" class=\"docClass\">activeTab</a> config option</p>\n",
      "params": [

      ],
      "return": {
        "type": "Ext.Component/Integer",
      ...
      "shortDoc": "Returns the item that is currently active inside this TabPanel. Note that before the TabPanel first activates a\nchild..."
    },
    {
      "tagname": "method",
      "name": "getBox",
    ...
    },
    {
      ...
      "shortDoc": "<p>Finds a docked component by id, itemId or position. Also see <a href=\"#/api/Ext.tab.Panel-method-getDockedItems\" rel=\"Ext.tab.Panel-method-getDockedItems\" class=\"docClass\">getDockedItems</a></p>\n"
    },
    {
      "tagname": "method",
      "name": "getDockedItems",
    ...
    },
    {
      ...
      "shortDoc": "<p>Returns the <a href=\"#/api/Ext.tab.Bar\" rel=\"Ext.tab.Bar\" class=\"docClass\">Ext.tab.Bar</a> currently used in this TabPanel</p>\n"
    },
    {
      "tagname": "method",
      "name": "getWidth",
    ...
    },
    {
      ...
      "name": "hasActiveFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.tab.Panel-method-getActiveAnimation\" rel=\"Ext.tab.Panel-method-getActiveAnimation\" class=\"docClass\">getActiveAnimation</a>\nReturns thq current animation if this object has any effects actively running or queued, else returns false.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.tab.Panel-cfg-hideMode\" rel=\"Ext.tab.Panel-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "insert",
    ...
    },
    {
      ...
      "name": "nextNode",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Returns the next node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree to attempt to find a match. Contrast with <a href=\"#/api/Ext.tab.Panel--pnextSibling\" rel=\"Ext.tab.Panel--pnextSibling\" class=\"docClass\">pnextSibling</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "selector",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.tab.Panel-method-addListener\" rel=\"Ext.tab.Panel-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.tab.Panel-method-addListener\" rel=\"Ext.tab.Panel-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.tab.Panel-method-addListener\" rel=\"Ext.tab.Panel-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "previousNode",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "doc": "<p>Removes a cls to the uiCls array, which will also call <a href=\"#/api/Ext.tab.Panel--removeUIClsToElement\" rel=\"Ext.tab.Panel--removeUIClsToElement\" class=\"docClass\">removeUIClsToElement</a> and removes\nit from all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.tab.Panel-method-addListener\" rel=\"Ext.tab.Panel-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.tab.Panel--mon\" rel=\"Ext.tab.Panel--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.tab.Panel--mon\" rel=\"Ext.tab.Panel--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.tab.Panel-method-suspendEvents\" rel=\"Ext.tab.Panel-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "params": [
        {
          "type": "Ext.Component",
          "name": "card",
          "doc": "<p>The card to make active</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Makes the given card active (makes it the visible card in the TabPanel's CardLayout and highlights the Tab)</p>\n"
    },
    {
      "tagname": "method",
      "name": "setAutoScroll",
    ...
    },
    {
      ...
      "params": [
        {
          "type": "Number",
          "name": "height",
          "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.tab.Panel-method-getEl\" rel=\"Ext.tab.Panel-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.tab.Panel-event-resize\" rel=\"Ext.tab.Panel-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "setIconCls",
      ...
      "params": [
        {
          "type": "Mixed",
          "name": "width",
          "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.tab.Panel-method-getEl\" rel=\"Ext.tab.Panel-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n",
          "optional": false
        },
        {
          "type": "Mixed",
    ...
    },
    {
      ...
      "shortDoc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.tab.Panel-event-resize\" rel=\"Ext.tab.Panel-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "show",
      "member": "Ext.Component",
      "doc": "<p>Shows this Component, rendering it first if <a href=\"#/api/Ext.tab.Panel-cfg-autoRender\" rel=\"Ext.tab.Panel-cfg-autoRender\" class=\"docClass\">autoRender</a> or {<a href=\"#/api/\"floating\" rel=\"\"floating\" class=\"docClass\">&quot;floating</a> are <code>true</code>.</p>\n\n\n<p>After being shown, a <a href=\"#/api/Ext.tab.Panel-cfg-floating\" rel=\"Ext.tab.Panel-cfg-floating\" class=\"docClass\">floating</a> Component (such as a <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Ext.window.Window</a>), is activated it and brought to the front of\nits <a href=\"#/api/Ext.tab.Panel--ZIndexManager\" rel=\"Ext.tab.Panel--ZIndexManager\" class=\"docClass\">z-index stack</a>.</p>\n\n",
      "params": [
        {
          "type": "String/Element",
          "name": "animateTarget",
    ...
    },
    {
      ...
      "name": "stopFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.tab.Panel-method-stopAnimation\" rel=\"Ext.tab.Panel-method-stopAnimation\" class=\"docClass\">stopAnimation</a>\nStops any running effects and clears this object's internal effects queue if it contains\nany additional effects that haven't started yet.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.tab.Panel-method-resumeEvents\" rel=\"Ext.tab.Panel-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.tab.Panel-method-resumeEvents\" rel=\"Ext.tab.Panel-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "syncFx",
    ...
    },
    {
      ...
      "shortDoc": "<p>Shortcut for performing an <a href=\"#/api/Ext.tab.Panel-method-expand\" rel=\"Ext.tab.Panel-method-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.tab.Panel-method-collapse\" rel=\"Ext.tab.Panel-method-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.tab.Panel-method-removeListener\" rel=\"Ext.tab.Panel-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.tab.Panel-method-removeListener\" rel=\"Ext.tab.Panel-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "up",
  ...
  "property": [
    ...
    },
    {
      ...
      "member": "Ext.tab.Panel",
      "type": "Object",
      "doc": "<p>At this point the item hasn't been removed from the items collection.\nAs such, if we want to check if there are no more tabs left, we have to\ncheck for one, as opposed to 0.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/tab/Panel.js",
      "linenr": 544,
      "html_filename": "Panel4.html",
      "href": "Panel4.html#Ext-tab-Panel-property-hasItemsLeft",
      "shortDoc": "At this point the item hasn't been removed from the items collection.\nAs such, if we want to check if there are no mo..."
    },
    {
      "tagname": "property",
      "name": "items",
  ...
  "event": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.tab.Panel-event-destroy\" rel=\"Ext.tab.Panel-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.tab.Panel-event-destroy\" rel=\"Ext.tab.Panel-event-destroy\" class=\"docClass\">destroy</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforehide",
      ...
      "shortDoc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.tab.Panel-event-hide\" rel=\"Ext.tab.Panel-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeremove",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.tab.Panel-property-rendered\" rel=\"Ext.tab.Panel-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.tab.Panel-event-render\" rel=\"Ext.tab.Panel-event-render\" class=\"docClass\">render</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeshow",
      ...
      "shortDoc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.tab.Panel-event-show\" rel=\"Ext.tab.Panel-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
    },
    {
      "tagname": "event",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before a tab change (activated by <a href=\"#/api/Ext.tab.Panel-method-setActiveTab\" rel=\"Ext.tab.Panel-method-setActiveTab\" class=\"docClass\">setActiveTab</a>). Return false in any listener to cancel\nthe tabchange</p>\n"
    },
    {
      "tagname": "event",
      "name": "bodyresize",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component is <a href=\"#/api/Ext.tab.Panel-event-destroy\" rel=\"Ext.tab.Panel-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
    },
    {
      "tagname": "event",
      "name": "disable",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component markup is <a href=\"#/api/Ext.tab.Panel-property-rendered\" rel=\"Ext.tab.Panel-property-rendered\" class=\"docClass\">rendered</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "resize",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.tab.Panel-event-show\" rel=\"Ext.tab.Panel-event-show\" class=\"docClass\">show</a> method.</p>\n"
    },
    {
      "tagname": "event",
      "name": "staterestore",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires when a new tab has been activated (activated by <a href=\"#/api/Ext.tab.Panel-method-setActiveTab\" rel=\"Ext.tab.Panel-method-setActiveTab\" class=\"docClass\">setActiveTab</a>).</p>\n"
    },
    {
      "tagname": "event",
      "name": "titlechange",
