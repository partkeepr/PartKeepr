Ext.data.JsonP.Ext_selection_DataViewModel({
  "tagname": "class",
  ...
  "cfg": [
    ...
    },
    {
      "tagname": "cfg",
      "name": "enableKeyNav",
      "member": "Ext.selection.DataViewModel",
      "type": "Boolean",
      "doc": "<p>Turns on/off keyboard navigation within the DataView. Defaults to true.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/selection/DataViewModel.js",
      "linenr": 12,
      "html_filename": "DataViewModel.html",
      "href": "DataViewModel.html#Ext-selection-DataViewModel-cfg-enableKeyNav"
    },
    {
      "tagname": "cfg",
      "name": "listeners",
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.selection.DataViewModel-method-enableBubble\" rel=\"Ext.selection.DataViewModel-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.selection.DataViewModel-method-addListener\" rel=\"Ext.selection.DataViewModel-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.selection.DataViewModel-method-addListener\" rel=\"Ext.selection.DataViewModel-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.selection.DataViewModel-method-addListener\" rel=\"Ext.selection.DataViewModel-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.selection.DataViewModel-method-addListener\" rel=\"Ext.selection.DataViewModel-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.selection.DataViewModel--mon\" rel=\"Ext.selection.DataViewModel--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.selection.DataViewModel--mon\" rel=\"Ext.selection.DataViewModel--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.selection.DataViewModel-method-suspendEvents\" rel=\"Ext.selection.DataViewModel-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "selectRange",
      "member": "Ext.selection.Model",
      "doc": "<p>Selects a range of rows if the selection model <a href=\"#/api/Ext.selection.DataViewModel-method-isLocked\" rel=\"Ext.selection.DataViewModel-method-isLocked\" class=\"docClass\">is not locked</a>.\nAll rows in between startRow and endRow are also selected.</p>\n",
      "params": [
        {
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.selection.DataViewModel-method-resumeEvents\" rel=\"Ext.selection.DataViewModel-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
          "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.selection.DataViewModel-method-resumeEvents\" rel=\"Ext.selection.DataViewModel-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events;</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.selection.DataViewModel-method-resumeEvents\" rel=\"Ext.selection.DataViewModel-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.selection.DataViewModel-method-removeListener\" rel=\"Ext.selection.DataViewModel-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.selection.DataViewModel-method-removeListener\" rel=\"Ext.selection.DataViewModel-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
  ...
  "event": [
    {
      ...
      "linenr": 21,
      "html_filename": "DataViewModel.html",
      "href": "DataViewModel.html#Ext-selection-DataViewModel-event-deselect",
    ...
    },
    {
      ...
      "linenr": 29,
      "html_filename": "DataViewModel.html",
      "href": "DataViewModel.html#Ext-selection-DataViewModel-event-select",
  ...
  "linenr": 1,
  "html_filename": "DataViewModel.html",
  "href": "DataViewModel.html#Ext-selection-DataViewModel",
  "cssVar": [
