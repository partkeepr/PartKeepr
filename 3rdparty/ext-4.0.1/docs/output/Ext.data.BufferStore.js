Ext.data.JsonP.Ext_data_BufferStore({
  "tagname": "class",
  ...
  "cfg": [
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "Boolean",
      "doc": "<p>For local filtering only, causes <a href=\"#/api/Ext.data.BufferStore-method-sort\" rel=\"Ext.data.BufferStore-method-sort\" class=\"docClass\">sort</a> to be called whenever <a href=\"#/api/Ext.data.BufferStore-method-filter\" rel=\"Ext.data.BufferStore-method-filter\" class=\"docClass\">filter</a> is called,\ncausing the sorters to be reapplied after filtering. Defaults to true</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 299,
      "html_filename": "Store2.html",
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "getGroups",
      "member": "Ext.data.Store",
      "doc": "<p>Returns an object containing the result of applying grouping to the records in this store. See <a href=\"#/api/Ext.data.BufferStore-property-groupField\" rel=\"Ext.data.BufferStore-property-groupField\" class=\"docClass\">groupField</a>,\n<a href=\"#/api/Ext.data.BufferStore-property-groupDir\" rel=\"Ext.data.BufferStore-property-groupDir\" class=\"docClass\">groupDir</a> and <a href=\"#/api/Ext.data.BufferStore-method-getGroupString\" rel=\"Ext.data.BufferStore-method-getGroupString\" class=\"docClass\">getGroupString</a>. Example for a store containing records with a color field:</p>\n\n<pre><code>var myStore = new Ext.data.Store({\n    groupField: 'color',\n    groupDir  : 'DESC'\n});\n\nmyStore.getGroups(); //returns:\n[\n    {\n        name: 'yellow',\n        children: [\n            //all records where the color field is 'yellow'\n        ]\n    },\n    {\n        name: 'red',\n        children: [\n            //all records where the color field is 'red'\n        ]\n    }\n]\n</code></pre>\n\n",
      "params": [
        {
          "type": "String",
          "name": "groupName",
          "doc": "<p>(Optional) Pass in an optional groupName argument to access a specific group as defined by <a href=\"#/api/Ext.data.BufferStore-method-getGroupString\" rel=\"Ext.data.BufferStore-method-getGroupString\" class=\"docClass\">getGroupString</a></p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "insert",
      "member": "Ext.data.Store",
      "doc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.data.BufferStore-event-add\" rel=\"Ext.data.BufferStore-event-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.data.BufferStore-event-add\" rel=\"Ext.data.BufferStore-event-add\" class=\"docClass\">add</a></code>.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "index",
      ...
      "shortDoc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.data.BufferStore-event-add\" rel=\"Ext.data.BufferStore-event-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.data.BufferStore-event-add\" rel=\"Ext.data.BufferStore-event-add\" class=\"docClass\">add</a></code>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "isFiltered",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.data.BufferStore-method-addListener\" rel=\"Ext.data.BufferStore-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.BufferStore-method-addListener\" rel=\"Ext.data.BufferStore-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.BufferStore-method-addListener\" rel=\"Ext.data.BufferStore-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "prefetch",
      "member": "Ext.data.Store",
      "doc": "<p>Prefetches data the Store using its configured <a href=\"#/api/Ext.data.BufferStore-cfg-proxy\" rel=\"Ext.data.BufferStore-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "options",
      ...
      "shortDoc": "<p>Prefetches data the Store using its configured <a href=\"#/api/Ext.data.BufferStore-cfg-proxy\" rel=\"Ext.data.BufferStore-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "prefetchPage",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.data.BufferStore-method-addListener\" rel=\"Ext.data.BufferStore-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.BufferStore--mon\" rel=\"Ext.data.BufferStore--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.BufferStore--mon\" rel=\"Ext.data.BufferStore--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.data.BufferStore-method-suspendEvents\" rel=\"Ext.data.BufferStore-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.BufferStore-method-resumeEvents\" rel=\"Ext.data.BufferStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.BufferStore-method-resumeEvents\" rel=\"Ext.data.BufferStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "sync",
    ...
    },
    {
      ...
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.BufferStore-method-removeListener\" rel=\"Ext.data.BufferStore-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.BufferStore-method-removeListener\" rel=\"Ext.data.BufferStore-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "Number",
      "doc": "<p>The page that the Store has most recently loaded (see <a href=\"#/api/Ext.data.BufferStore-method-loadPage\" rel=\"Ext.data.BufferStore-method-loadPage\" class=\"docClass\">loadPage</a>)</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 277,
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Boolean",
      "doc": "<p>True if the Store has already been destroyed via <a href=\"#/api/Ext.data.BufferStore--destroyStore\" rel=\"Ext.data.BufferStore--destroyStore\" class=\"docClass\">destroyStore</a>. If this is true, the reference to Store should be deleted\nas it will not function correctly any more.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 111,
  ...
  "event": [
    ...
    },
    {
      ...
      "name": "beforesync",
      "member": "Ext.data.AbstractStore",
      "doc": "<p>Called before a call to <a href=\"#/api/Ext.data.BufferStore-method-sync\" rel=\"Ext.data.BufferStore-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "options",
      ...
      "shortDoc": "<p>Called before a call to <a href=\"#/api/Ext.data.BufferStore-method-sync\" rel=\"Ext.data.BufferStore-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n"
    },
    {
      "tagname": "event",
      "name": "clear",
      "member": "Ext.data.AbstractStore",
      "doc": "<p>Fired after the <a href=\"#/api/Ext.data.BufferStore-method-removeAll\" rel=\"Ext.data.BufferStore-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n",
      "params": [
        {
          "type": "Ext.data.Store",
          "name": "this",
      ...
      "shortDoc": "<p>Fired after the <a href=\"#/api/Ext.data.BufferStore-method-removeAll\" rel=\"Ext.data.BufferStore-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n"
    },
    {
      "tagname": "event",
      "name": "datachanged",
  ...
  "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/BufferStore.js",
  "linenr": 1,
  "html_filename": "BufferStore.html",
  "href": "BufferStore.html#Ext-data-BufferStore",
  "cssVar": [
