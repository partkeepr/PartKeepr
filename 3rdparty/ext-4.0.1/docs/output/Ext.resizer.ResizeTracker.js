Ext.data.JsonP.Ext_resizer_ResizeTracker({
  "tagname": "class",
  ...
  "cfg": [
    ...
    },
    {
      ...
      "member": "Ext.dd.DragTracker",
      "type": "String",
      "doc": "<p>A CSS class to add to the DragTracker's target element when the element (or, if the <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> option is used,\nwhen a delegate element) is mouseovered.</p>\n\n\n<p><b>If the <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> option is used, these events fire only when a delegate element is entered of left.</b>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/dd/DragTracker.js",
      "linenr": 42,
      "html_filename": "DragTracker.html",
    ...
    },
    {
      ...
      "member": "Ext.dd.DragTracker",
      "type": "Boolean",
      "doc": "<p>Defaults to <code>false</code>. Set to true to fire mouseover and mouseout events when the mouse enters or leaves the target element.</p>\n\n\n<p>This is implicitly set when an <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-overCls\" rel=\"Ext.resizer.ResizeTracker-cfg-overCls\" class=\"docClass\">overCls</a> is specified.</p>\n\n\n<p><b>If the <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> option is used, these events fire only when a delegate element is entered of left.</b>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/dd/DragTracker.js",
      "linenr": 34,
      "html_filename": "DragTracker.html",
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.resizer.ResizeTracker-method-enableBubble\" rel=\"Ext.resizer.ResizeTracker-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "name": "getDragTarget",
      "member": "Ext.dd.DragTracker",
      "doc": "<p></p>Returns the drag target. This is usually the DragTracker's encapsulating element.</p></p>\n\n<p>If the <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> option is being used, this may be a child element which matches the\n<a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> selector.</p>\n\n",
      "params": [
    ...
    },
    {
      ...
      "name": "getOffset",
      "member": "Ext.dd.DragTracker",
      "doc": "<p>Returns the X, Y offset of the current mouse position from the mousedown point.</p>\n\n\n<p>This method may optionally constrain the real offset values, and returns a point coerced in one\nof two modes:</p>\n\n\n<ul>\n<li><code>point</code><div class=\"sub-desc\">The current mouse position is coerced into the\n<a href=\"#/api/Ext.resizer.ResizeTracker--constrainRegion\" rel=\"Ext.resizer.ResizeTracker--constrainRegion\" class=\"docClass\">constrainRegion</a>, and the resulting position is returned.</div></li>\n<li><code>dragTarget</code><div class=\"sub-desc\">The new <a href=\"#/api/Ext.util.Region\" rel=\"Ext.util.Region\" class=\"docClass\">Region</a> of the\n<a href=\"#/api/Ext.resizer.ResizeTracker-method-getDragTarget\" rel=\"Ext.resizer.ResizeTracker-method-getDragTarget\" class=\"docClass\">dragTarget</a> is calculated based upon the current mouse position, and then\ncoerced into the <a href=\"#/api/Ext.resizer.ResizeTracker--constrainRegion\" rel=\"Ext.resizer.ResizeTracker--constrainRegion\" class=\"docClass\">constrainRegion</a>. The returned mouse position is then adjusted by the\nsame delta as was used to coerce the region.</div></li>\n</ul>\n\n",
      "params": [
        {
          "type": "Object",
          "name": "constrainMode",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.resizer.ResizeTracker-method-addListener\" rel=\"Ext.resizer.ResizeTracker-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.resizer.ResizeTracker-method-addListener\" rel=\"Ext.resizer.ResizeTracker-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.resizer.ResizeTracker-method-addListener\" rel=\"Ext.resizer.ResizeTracker-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "onBeforeStart",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.resizer.ResizeTracker-method-addListener\" rel=\"Ext.resizer.ResizeTracker-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.resizer.ResizeTracker--mon\" rel=\"Ext.resizer.ResizeTracker--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.resizer.ResizeTracker--mon\" rel=\"Ext.resizer.ResizeTracker--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.resizer.ResizeTracker-method-suspendEvents\" rel=\"Ext.resizer.ResizeTracker-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.resizer.ResizeTracker-method-resumeEvents\" rel=\"Ext.resizer.ResizeTracker-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
          "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.resizer.ResizeTracker-method-resumeEvents\" rel=\"Ext.resizer.ResizeTracker-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events;</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.resizer.ResizeTracker-method-resumeEvents\" rel=\"Ext.resizer.ResizeTracker-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.resizer.ResizeTracker-method-removeListener\" rel=\"Ext.resizer.ResizeTracker-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.resizer.ResizeTracker-method-removeListener\" rel=\"Ext.resizer.ResizeTracker-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
    ...
    },
    {
      ...
      "member": "Ext.dd.DragTracker",
      "type": "HtmlElement",
      "doc": "<p><b>Only valid during drag operations. Read-only.</b></p>\n\n\n<p>The element being dragged.</p>\n\n\n<p>If the <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> option is used, this will be the delegate element which was mousedowned.</p>\n\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/dd/DragTracker.js",
      "linenr": 26,
  ...
  "event": [
    ...
    },
    {
      ...
      "name": "mousedown",
      "member": "Ext.dd.DragTracker",
      "doc": "<p>Fires when the mouse button is pressed down, but before a drag operation begins. The\ndrag operation begins after either the mouse has been moved by <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-tolerance\" rel=\"Ext.resizer.ResizeTracker-cfg-tolerance\" class=\"docClass\">tolerance</a> pixels, or after\nthe <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-autoStart\" rel=\"Ext.resizer.ResizeTracker-cfg-autoStart\" class=\"docClass\">autoStart</a> timer fires.</p>\n\n\n<p>Return false to veto the drag operation.</p>\n\n",
      "params": [
        {
          "type": "Object",
          "name": "this",
    ...
    },
    {
      ...
      "name": "mouseout",
      "member": "Ext.dd.DragTracker",
      "doc": "<p><b>Only available when <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-trackOver\" rel=\"Ext.resizer.ResizeTracker-cfg-trackOver\" class=\"docClass\">trackOver</a> is <code>true</code></b></p>\n\n\n<p>Fires when the mouse exits the DragTracker's target element (or if <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> is\nused, when the mouse exits a delegate element).</p>\n\n",
      "params": [
        {
          "type": "Object",
          "name": "this",
    ...
    },
    {
      ...
      "name": "mouseover",
      "member": "Ext.dd.DragTracker",
      "doc": "<p><b>Only available when <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-trackOver\" rel=\"Ext.resizer.ResizeTracker-cfg-trackOver\" class=\"docClass\">trackOver</a> is <code>true</code></b></p>\n\n\n<p>Fires when the mouse enters the DragTracker's target element (or if <a href=\"#/api/Ext.resizer.ResizeTracker-cfg-delegate\" rel=\"Ext.resizer.ResizeTracker-cfg-delegate\" class=\"docClass\">delegate</a> is\nused, when the mouse enters a delegate element).</p>\n\n",
      "params": [
        {
          "type": "Object",
          "name": "this",
  ...
  "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/resizer/ResizeTracker.js",
  "linenr": 1,
  "html_filename": "ResizeTracker.html",
  "href": "ResizeTracker.html#Ext-resizer-ResizeTracker",
  "cssVar": [
