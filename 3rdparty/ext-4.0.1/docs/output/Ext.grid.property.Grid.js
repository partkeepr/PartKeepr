Ext.data.JsonP.Ext_grid_property_Grid({
  ...
  "method": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Finds a docked component by id, itemId or position. Also see <a href=\"#/api/Ext.grid.property.Grid-method-getDockedItems\" rel=\"Ext.grid.property.Grid-method-getDockedItems\" class=\"docClass\">getDockedItems</a></p>\n"
    },
    {
      "tagname": "method",
      "name": "getDockedItems",
    ...
    },
    {
      ...
      "shortDoc": "Gets the source data object containing the property data.  See setSource for details regarding the\nformat of the data..."
    },
    {
      "tagname": "method",
      "name": "getState",
    ...
    },
    {
      ...
      "name": "hasActiveFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.property.Grid-method-getActiveAnimation\" rel=\"Ext.grid.property.Grid-method-getActiveAnimation\" class=\"docClass\">getActiveAnimation</a>\nReturns thq current animation if this object has any effects actively running or queued, else returns false.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.grid.property.Grid-cfg-hideMode\" rel=\"Ext.grid.property.Grid-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n"
    },
    {
      "tagname": "method",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.grid.property.Grid-method-addListener\" rel=\"Ext.grid.property.Grid-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.property.Grid-method-addListener\" rel=\"Ext.grid.property.Grid-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.property.Grid-method-addListener\" rel=\"Ext.grid.property.Grid-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "previousNode",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "doc": "<p>Removes a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.property.Grid--removeUIClsToElement\" rel=\"Ext.grid.property.Grid--removeUIClsToElement\" class=\"docClass\">removeUIClsToElement</a> and removes\nit from all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.grid.property.Grid-method-addListener\" rel=\"Ext.grid.property.Grid-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.property.Grid--mon\" rel=\"Ext.grid.property.Grid--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.property.Grid--mon\" rel=\"Ext.grid.property.Grid--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "removeProperty",
      ...
      "shortDoc": "<p>Removes a property from the grid.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.grid.property.Grid-method-suspendEvents\" rel=\"Ext.grid.property.Grid-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.grid.property.Grid-event-resize\" rel=\"Ext.grid.property.Grid-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "setIconCls",
    ...
    },
    {
      ...
      "shortDoc": "<p>Sets the value of a property.</p>\n"
    },
    {
      "tagname": "method",
      "name": "setScrollTop",
    ...
    },
    {
      ...
      "shortDoc": "Sets the source data object containing the property data.  The data object can contain one or more name/value\npairs r..."
    },
    {
      "tagname": "method",
      "name": "setTitle",
    ...
    },
    {
      ...
      "shortDoc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.grid.property.Grid-event-resize\" rel=\"Ext.grid.property.Grid-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "show",
      "member": "Ext.Component",
      "doc": "<p>Shows this Component, rendering it first if <a href=\"#/api/Ext.grid.property.Grid-cfg-autoRender\" rel=\"Ext.grid.property.Grid-cfg-autoRender\" class=\"docClass\">autoRender</a> or {<a href=\"#/api/\"floating\" rel=\"\"floating\" class=\"docClass\">&quot;floating</a> are <code>true</code>.</p>\n\n\n<p>After being shown, a <a href=\"#/api/Ext.grid.property.Grid-cfg-floating\" rel=\"Ext.grid.property.Grid-cfg-floating\" class=\"docClass\">floating</a> Component (such as a <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Ext.window.Window</a>), is activated it and brought to the front of\nits <a href=\"#/api/Ext.grid.property.Grid--ZIndexManager\" rel=\"Ext.grid.property.Grid--ZIndexManager\" class=\"docClass\">z-index stack</a>.</p>\n\n",
      "params": [
        {
          "type": "String/Element",
          "name": "animateTarget",
    ...
    },
    {
      ...
      "name": "stopFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.property.Grid-method-stopAnimation\" rel=\"Ext.grid.property.Grid-method-stopAnimation\" class=\"docClass\">stopAnimation</a>\nStops any running effects and clears this object's internal effects queue if it contains\nany additional effects that haven't started yet.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.property.Grid-method-resumeEvents\" rel=\"Ext.grid.property.Grid-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.property.Grid-method-resumeEvents\" rel=\"Ext.grid.property.Grid-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "syncFx",
    ...
    },
    {
      ...
      "shortDoc": "<p>Shortcut for performing an <a href=\"#/api/Ext.grid.property.Grid-method-expand\" rel=\"Ext.grid.property.Grid-method-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.grid.property.Grid-method-collapse\" rel=\"Ext.grid.property.Grid-method-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.property.Grid-method-removeListener\" rel=\"Ext.grid.property.Grid-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.property.Grid-method-removeListener\" rel=\"Ext.grid.property.Grid-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "up",
  ...
  "event": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.property.Grid-event-destroy\" rel=\"Ext.grid.property.Grid-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.grid.property.Grid-event-destroy\" rel=\"Ext.grid.property.Grid-event-destroy\" class=\"docClass\">destroy</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforehide",
      ...
      "shortDoc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.grid.property.Grid-event-hide\" rel=\"Ext.grid.property.Grid-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
    },
    {
      "tagname": "event",
    ...
    },
    {
      ...
      "shortDoc": "Fires before a property value changes.  Handlers can return false to cancel the property change\n(this will internally..."
    },
    {
      "tagname": "event",
      "name": "beforeremove",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.property.Grid-property-rendered\" rel=\"Ext.grid.property.Grid-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.grid.property.Grid-event-render\" rel=\"Ext.grid.property.Grid-event-render\" class=\"docClass\">render</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeselect",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.grid.property.Grid-event-show\" rel=\"Ext.grid.property.Grid-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
    },
    {
      "tagname": "event",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component is <a href=\"#/api/Ext.grid.property.Grid-event-destroy\" rel=\"Ext.grid.property.Grid-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
    },
    {
      "tagname": "event",
      "name": "disable",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after a property value has changed.</p>\n"
    },
    {
      "tagname": "event",
      "name": "remove",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component markup is <a href=\"#/api/Ext.grid.property.Grid-property-rendered\" rel=\"Ext.grid.property.Grid-property-rendered\" class=\"docClass\">rendered</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "resize",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.grid.property.Grid-event-show\" rel=\"Ext.grid.property.Grid-event-show\" class=\"docClass\">show</a> method.</p>\n"
    },
    {
      "tagname": "event",
      "name": "staterestore",
