Ext.data.JsonP.Ext_data_JsonPStore({
  ...
  "cfg": [
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "Boolean",
      "doc": "<p>True to empty the store when loading another page via <a href=\"#/api/Ext.data.JsonPStore-method-loadPage\" rel=\"Ext.data.JsonPStore-method-loadPage\" class=\"docClass\">loadPage</a>,\n<a href=\"#/api/Ext.data.JsonPStore-method-nextPage\" rel=\"Ext.data.JsonPStore-method-nextPage\" class=\"docClass\">nextPage</a> or <a href=\"#/api/Ext.data.JsonPStore-method-previousPage\" rel=\"Ext.data.JsonPStore-method-previousPage\" class=\"docClass\">previousPage</a> (defaults to true). Setting to false keeps existing records, allowing\nlarge data sets to be loaded one page at a time but rendered all together.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 284,
      "html_filename": "Store2.html",
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Array",
      "doc": "<p>This may be used in place of specifying a <a href=\"#/api/Ext.data.JsonPStore-cfg-model\" rel=\"Ext.data.JsonPStore-cfg-model\" class=\"docClass\">model</a> configuration. The fields should be a\nset of <a href=\"#/api/Ext.data.Field\" rel=\"Ext.data.Field\" class=\"docClass\">Ext.data.Field</a> configuration objects. The store will automatically create a <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a>\nwith these fields. In general this configuration option should be avoided, it exists for the purposes of\nbackwards compatibility. For anything more complicated, such as specifying a particular id property or\nassocations, a <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> should be defined and specified for the <a href=\"#/api/Ext.data.JsonPStore-cfg-model\" rel=\"Ext.data.JsonPStore-cfg-model\" class=\"docClass\">model</a> config.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 126,
      "html_filename": "AbstractStore.html",
    ...
    },
    {
      ...
      "doc": "<p>The Proxy to use for this Store. This can be either a string, a config\nobject or a Proxy instance - see <a href=\"#/api/Ext.data.JsonPStore-method-setProxy\" rel=\"Ext.data.JsonPStore-method-setProxy\" class=\"docClass\">setProxy</a> for details.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 241,
      "html_filename": "Store2.html",
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "Number",
      "doc": "<p>The number of pages to keep in the cache before purging additional records. A value of 0 indicates to never purge the prefetched data.\nThis option is only relevant when the <a href=\"#/api/Ext.data.JsonPStore-cfg-buffered\" rel=\"Ext.data.JsonPStore-cfg-buffered\" class=\"docClass\">buffered</a> option is set to true.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 312,
      "html_filename": "Store2.html",
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "Boolean",
      "doc": "<p>For local filtering only, causes <a href=\"#/api/Ext.data.JsonPStore-method-sort\" rel=\"Ext.data.JsonPStore-method-sort\" class=\"docClass\">sort</a> to be called whenever <a href=\"#/api/Ext.data.JsonPStore-method-filter\" rel=\"Ext.data.JsonPStore-method-filter\" class=\"docClass\">filter</a> is called,\ncausing the sorters to be reapplied after filtering. Defaults to true</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 299,
      "html_filename": "Store2.html",
  ...
  "method": [
    {
      ...
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/JsonPStore.js",
      "linenr": 1,
      "html_filename": "JsonPStore.html",
      "href": "JsonPStore.html#Ext-data-JsonPStore-method-constructor",
      "shortDoc": "\n"
    },
    {
      "tagname": "method",
      ...
      "params": [
        {
          "type": "Boolean",
          "name": "suppressEvent",
          "doc": "<p>If <tt>true</tt> the filter is cleared silently without firing the\n<a href=\"#/api/Ext.data.JsonPStore-event-datachanged\" rel=\"Ext.data.JsonPStore-event-datachanged\" class=\"docClass\">datachanged</a> event.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.data.JsonPStore-method-enableBubble\" rel=\"Ext.data.JsonPStore-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "name": "getCount",
      "member": "Ext.data.Store",
      "doc": "<p>Gets the number of cached records.</p>\n\n<p>If using paging, this may not be the total size of the dataset. If the data object\nused by the Reader contains the dataset size, then the <a href=\"#/api/Ext.data.JsonPStore-method-getTotalCount\" rel=\"Ext.data.JsonPStore-method-getTotalCount\" class=\"docClass\">getTotalCount</a> function returns\nthe dataset size.  <b>Note</b>: see the Important note in <a href=\"#/api/Ext.data.JsonPStore-event-load\" rel=\"Ext.data.JsonPStore-event-load\" class=\"docClass\">load</a>.</p>\n\n",
      "params": [
    ...
    },
    {
      ...
      "name": "getGroups",
      "member": "Ext.data.Store",
      "doc": "<p>Returns an object containing the result of applying grouping to the records in this store. See <a href=\"#/api/Ext.data.JsonPStore-property-groupField\" rel=\"Ext.data.JsonPStore-property-groupField\" class=\"docClass\">groupField</a>,\n<a href=\"#/api/Ext.data.JsonPStore-property-groupDir\" rel=\"Ext.data.JsonPStore-property-groupDir\" class=\"docClass\">groupDir</a> and <a href=\"#/api/Ext.data.JsonPStore-method-getGroupString\" rel=\"Ext.data.JsonPStore-method-getGroupString\" class=\"docClass\">getGroupString</a>. Example for a store containing records with a color field:</p>\n\n<pre><code>var myStore = new Ext.data.Store({\n    groupField: 'color',\n    groupDir  : 'DESC'\n});\n\nmyStore.getGroups(); //returns:\n[\n    {\n        name: 'yellow',\n        children: [\n            //all records where the color field is 'yellow'\n        ]\n    },\n    {\n        name: 'red',\n        children: [\n            //all records where the color field is 'red'\n        ]\n    }\n]\n</code></pre>\n\n",
      "params": [
        {
          "type": "String",
          "name": "groupName",
          "doc": "<p>(Optional) Pass in an optional groupName argument to access a specific group as defined by <a href=\"#/api/Ext.data.JsonPStore-method-getGroupString\" rel=\"Ext.data.JsonPStore-method-getGroupString\" class=\"docClass\">getGroupString</a></p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "insert",
      "member": "Ext.data.Store",
      "doc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.data.JsonPStore-event-add\" rel=\"Ext.data.JsonPStore-event-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.data.JsonPStore-event-add\" rel=\"Ext.data.JsonPStore-event-add\" class=\"docClass\">add</a></code>.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "index",
      ...
      "shortDoc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.data.JsonPStore-event-add\" rel=\"Ext.data.JsonPStore-event-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.data.JsonPStore-event-add\" rel=\"Ext.data.JsonPStore-event-add\" class=\"docClass\">add</a></code>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "isFiltered",
    ...
    },
    {
      ...
      "name": "loadRecords",
      "member": "Ext.data.Store",
      "doc": "<p>Loads an array of {@Ext.data.Model model} instances into the store, fires the datachanged event. This should only usually\nbe called internally when loading from the <a href=\"#/api/Ext.data.proxy.Proxy\" rel=\"Ext.data.proxy.Proxy\" class=\"docClass\">Proxy</a>, when adding records manually use <a href=\"#/api/Ext.data.JsonPStore-event-add\" rel=\"Ext.data.JsonPStore-event-add\" class=\"docClass\">add</a> instead</p>\n",
      "params": [
        {
          "type": "Array",
          "name": "records",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.data.JsonPStore-method-addListener\" rel=\"Ext.data.JsonPStore-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.JsonPStore-method-addListener\" rel=\"Ext.data.JsonPStore-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.JsonPStore-method-addListener\" rel=\"Ext.data.JsonPStore-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "prefetch",
      "member": "Ext.data.Store",
      "doc": "<p>Prefetches data the Store using its configured <a href=\"#/api/Ext.data.JsonPStore-cfg-proxy\" rel=\"Ext.data.JsonPStore-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "options",
          "doc": "<p>Optional config object, passed into the <a href=\"#/api/Ext.data.Operation\" rel=\"Ext.data.Operation\" class=\"docClass\">Ext.data.Operation</a> object before loading.\nSee <a href=\"#/api/Ext.data.JsonPStore-event-load\" rel=\"Ext.data.JsonPStore-event-load\" class=\"docClass\">load</a></p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Prefetches data the Store using its configured <a href=\"#/api/Ext.data.JsonPStore-cfg-proxy\" rel=\"Ext.data.JsonPStore-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "prefetchPage",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.data.JsonPStore-method-addListener\" rel=\"Ext.data.JsonPStore-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.JsonPStore--mon\" rel=\"Ext.data.JsonPStore--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.JsonPStore--mon\" rel=\"Ext.data.JsonPStore--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.data.JsonPStore-method-suspendEvents\" rel=\"Ext.data.JsonPStore-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.JsonPStore-method-resumeEvents\" rel=\"Ext.data.JsonPStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
          "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.data.JsonPStore-method-resumeEvents\" rel=\"Ext.data.JsonPStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events;</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.JsonPStore-method-resumeEvents\" rel=\"Ext.data.JsonPStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "sync",
    ...
    },
    {
      ...
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.JsonPStore-method-removeListener\" rel=\"Ext.data.JsonPStore-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.JsonPStore-method-removeListener\" rel=\"Ext.data.JsonPStore-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "Number",
      "doc": "<p>The page that the Store has most recently loaded (see <a href=\"#/api/Ext.data.JsonPStore-method-loadPage\" rel=\"Ext.data.JsonPStore-method-loadPage\" class=\"docClass\">loadPage</a>)</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 277,
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Boolean",
      "doc": "<p>If true, any filters attached to this Store will be run after loading data, before the datachanged event is fired.\nDefaults to true, ignored if <a href=\"#/api/Ext.data.JsonPStore-cfg-remoteFilter\" rel=\"Ext.data.JsonPStore-cfg-remoteFilter\" class=\"docClass\">remoteFilter</a> is true</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 79,
    ...
    },
    {
      ...
      "member": "Ext.data.Store",
      "type": "String",
      "doc": "<p>The (optional) field by which to group data in the store. Internally, grouping is very similar to sorting - the\ngroupField and <a href=\"#/api/Ext.data.JsonPStore-property-groupDir\" rel=\"Ext.data.JsonPStore-property-groupDir\" class=\"docClass\">groupDir</a> are injected as the first sorter (see <a href=\"#/api/Ext.data.JsonPStore-method-sort\" rel=\"Ext.data.JsonPStore-method-sort\" class=\"docClass\">sort</a>). Stores support a single\nlevel of grouping, and groups can be fetched via the <a href=\"#/api/Ext.data.JsonPStore-method-getGroups\" rel=\"Ext.data.JsonPStore-method-getGroups\" class=\"docClass\">getGroups</a> method.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/Store.js",
      "linenr": 254,
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Boolean",
      "doc": "<p>True if the Store has already been destroyed via <a href=\"#/api/Ext.data.JsonPStore--destroyStore\" rel=\"Ext.data.JsonPStore--destroyStore\" class=\"docClass\">destroyStore</a>. If this is true, the reference to Store should be deleted\nas it will not function correctly any more.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 111,
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Boolean",
      "doc": "<p>If true, any sorters attached to this Store will be run after loading data, before the datachanged event is fired.\nDefaults to true, igored if <a href=\"#/api/Ext.data.JsonPStore-cfg-remoteSort\" rel=\"Ext.data.JsonPStore-cfg-remoteSort\" class=\"docClass\">remoteSort</a> is true</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 87,
  ...
  "event": [
    ...
    },
    {
      ...
      "name": "beforesync",
      "member": "Ext.data.AbstractStore",
      "doc": "<p>Called before a call to <a href=\"#/api/Ext.data.JsonPStore-method-sync\" rel=\"Ext.data.JsonPStore-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "options",
      ...
      "shortDoc": "<p>Called before a call to <a href=\"#/api/Ext.data.JsonPStore-method-sync\" rel=\"Ext.data.JsonPStore-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n"
    },
    {
      "tagname": "event",
      "name": "clear",
      "member": "Ext.data.AbstractStore",
      "doc": "<p>Fired after the <a href=\"#/api/Ext.data.JsonPStore-method-removeAll\" rel=\"Ext.data.JsonPStore-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n",
      "params": [
        {
          "type": "Ext.data.Store",
          "name": "this",
      ...
      "shortDoc": "<p>Fired after the <a href=\"#/api/Ext.data.JsonPStore-method-removeAll\" rel=\"Ext.data.JsonPStore-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n"
    },
    {
      "tagname": "event",
      "name": "datachanged",
  ...
  "linenr": 1,
  "html_filename": "JsonPStore.html",
  "href": "JsonPStore.html#Ext-data-JsonPStore",
  "cssVar": [
