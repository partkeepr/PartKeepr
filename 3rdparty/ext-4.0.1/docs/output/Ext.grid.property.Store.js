Ext.data.JsonP.Ext_grid_property_Store({
  ...
  "method": [
    {
      "tagname": "method",
      "name": "Store",
      "member": "Ext.grid.property.Store",
      "doc": "\n",
      "params": [
        {
          "type": "Ext.grid.Grid",
      ...
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/grid/property/Store.js",
      "linenr": 1,
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.grid.property.Store-method-enableBubble\" rel=\"Ext.grid.property.Store-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "shortDoc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.grid.property.Store-event-add\" rel=\"Ext.grid.property.Store-event-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.grid.property.Store-event-add\" rel=\"Ext.grid.property.Store-event-add\" class=\"docClass\">add</a></code>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "isFiltered",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.grid.property.Store-method-addListener\" rel=\"Ext.grid.property.Store-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.property.Store-method-addListener\" rel=\"Ext.grid.property.Store-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.property.Store-method-addListener\" rel=\"Ext.grid.property.Store-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "prefetch",
      "member": "Ext.data.Store",
      "doc": "<p>Prefetches data the Store using its configured <a href=\"#/api/Ext.grid.property.Store-cfg-proxy\" rel=\"Ext.grid.property.Store-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "options",
      ...
      "shortDoc": "<p>Prefetches data the Store using its configured <a href=\"#/api/Ext.grid.property.Store-cfg-proxy\" rel=\"Ext.grid.property.Store-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "prefetchPage",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.grid.property.Store-method-addListener\" rel=\"Ext.grid.property.Store-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.property.Store--mon\" rel=\"Ext.grid.property.Store--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.property.Store--mon\" rel=\"Ext.grid.property.Store--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.grid.property.Store-method-suspendEvents\" rel=\"Ext.grid.property.Store-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.property.Store-method-resumeEvents\" rel=\"Ext.grid.property.Store-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.property.Store-method-resumeEvents\" rel=\"Ext.grid.property.Store-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "sync",
    ...
    },
    {
      ...
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.property.Store-method-removeListener\" rel=\"Ext.grid.property.Store-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.property.Store-method-removeListener\" rel=\"Ext.grid.property.Store-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Boolean",
      "doc": "<p>True if the Store has already been destroyed via <a href=\"#/api/Ext.grid.property.Store--destroyStore\" rel=\"Ext.grid.property.Store--destroyStore\" class=\"docClass\">destroyStore</a>. If this is true, the reference to Store should be deleted\nas it will not function correctly any more.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 111,
  ...
  "event": [
    ...
    },
    {
      ...
      "name": "beforesync",
      "member": "Ext.data.AbstractStore",
      "doc": "<p>Called before a call to <a href=\"#/api/Ext.grid.property.Store-method-sync\" rel=\"Ext.grid.property.Store-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "options",
      ...
      "shortDoc": "<p>Called before a call to <a href=\"#/api/Ext.grid.property.Store-method-sync\" rel=\"Ext.grid.property.Store-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n"
    },
    {
      "tagname": "event",
      "name": "clear",
      ...
      "shortDoc": "<p>Fired after the <a href=\"#/api/Ext.grid.property.Store-method-removeAll\" rel=\"Ext.grid.property.Store-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n"
    },
    {
      "tagname": "event",
      "name": "datachanged",
