Ext.data.JsonP.Ext_Date({
  ...
  "method": [
    {
      ...
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/core/src/lang/Date.js",
      "linenr": 1283,
      "html_filename": "Date4.html",
      "href": "Date4.html#Ext-Date-method-add",
      "shortDoc": "Provides a convenient method for performing basic date arithmetic. This method\ndoes not modify the Date instance bein..."
    },
    {
      "tagname": "method",
      "name": "between",
      ...
      "shortDoc": "<p>Checks if a date falls on or between the given start and end dates.</p>\n"
    },
    {
      "tagname": "method",
      "name": "clearTime",
    ...
    },
    {
      ...
      "shortDoc": "<p>Formats a date given the supplied format string.</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "<p>Checks if the specified format contains information about\nanything other than the time.</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "<p>Checks if the specified format contains hour information</p>\n"
    },
    {
      "tagname": "method",
      "name": "getDayOfYear",
      ...
      "shortDoc": "<p>Get the numeric day number of the year, adjusted for leap year.</p>\n"
    },
    {
      "tagname": "method",
      "name": "getDaysInMonth",
      ...
      "shortDoc": "<p>Get the number of days in the current month, adjusted for leap year.</p>\n"
    },
    {
      "tagname": "method",
      "name": "getElapsed",
      ...
      "shortDoc": "<p>Returns the number of milliseconds between two dates</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "<p>Get the date of the first day of the month in which this date resides.</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "Get the first day of the current month, adjusted for leap year.  The returned value\nis the numeric day index within t..."
    },
    {
      "tagname": "method",
      "name": "getGMTOffset",
      ...
      "shortDoc": "<p>Get the offset from GMT of the current date (equivalent to the format specifier 'O').</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "<p>Get the date of the last day of the month in which this date resides.</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "Get the last day of the current month, adjusted for leap year.  The returned value\nis the numeric day index within th..."
    },
    {
      "tagname": "method",
      "name": "getMonthNumber",
    ...
    },
    {
      ...
      "shortDoc": "<p>Get the short day name for the given day number.\nOverride this function for international dates.</p>\n"
    },
    {
      "tagname": "method",
      ...
      "shortDoc": "<p>Get the short month name for the given month number.\nOverride this function for international dates.</p>\n"
    },
    {
      "tagname": "method",
      "name": "getSuffix",
      ...
      "shortDoc": "<p>Get the English ordinal suffix of the current day (equivalent to the format specifier 'S').</p>\n"
    },
    {
      "tagname": "method",
      "name": "getTimezone",
    ...
    },
    {
      ...
      "shortDoc": "<p>Get the numeric ISO-8601 week number of the year.\n(equivalent to the format specifier 'W', but without a leading zero).</p>\n"
    },
    {
      "tagname": "method",
      "name": "isDST",
      ...
      "shortDoc": "<p>Checks if the current date is affected by Daylight Saving Time (DST).</p>\n"
    },
    {
      "tagname": "method",
      "name": "isLeapYear",
      ...
      "shortDoc": "<p>Checks if the current date falls within a leap year.</p>\n"
    },
    {
      "tagname": "method",
      "name": "isValid",
      ...
      "shortDoc": "<p>Checks if the passed Date parameters will cause a javascript Date \"rollover\".</p>\n"
    },
    {
      "tagname": "method",
      "name": "now",
      ...
      "shortDoc": "<p>Returns the current timestamp</p>\n"
    },
    {
      "tagname": "method",
      "name": "parse",
  ...
  "property": [
    ...
    },
    {
      ...
      "member": "Ext.Date",
      "type": "String",
      "doc": "<p>The date format string that the <a href=\"#/api/Ext.Date--dateRenderer\" rel=\"Ext.Date--dateRenderer\" class=\"docClass\">dateRenderer</a> and <a href=\"#/api/Ext.Date--date\" rel=\"Ext.Date--date\" class=\"docClass\">date</a> functions use.\nsee <a href=\"#/api/Ext.Date--Date\" rel=\"Ext.Date--Date\" class=\"docClass\">Date</a> for details.</p>\n\n\n<p>This defaults to <code>m/d/Y</code>, but may be overridden in a locale file.</p>\n\n",
      "private": false,
      "static": true,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/core/src/lang/Date.js",
      "linenr": 415,
      ...
      "shortDoc": "The date format string that the dateRenderer and date functions use.\nsee Date for details.\n\n\nThis defaults to m/d/Y, ..."
    },
    {
      "tagname": "property",
      "name": "defaults",
    ...
    },
    {
      ...
      "shortDoc": "An object hash in which each property is a date formatting function. The property name is the\nformat string which cor..."
    },
    {
      "tagname": "property",
      "name": "monthNames",
    ...
    },
    {
      ...
      "shortDoc": "An object hash of zero-based javascript month numbers (with short month names as keys. note: keys are case-sensitive)..."
    },
    {
      "tagname": "property",
      "name": "parseFunctions",
      ...
      "shortDoc": "An object hash in which each property is a date parsing function. The property name is the\nformat string which that f..."
    },
    {
      "tagname": "property",
      "name": "useStrict",
