Ext.data.JsonP.Ext_grid_plugin_RowEditing({
  ...
  "cfg": [
    {
      "tagname": "cfg",
      "name": "autoCancel",
      "member": "Ext.grid.plugin.RowEditing",
      "type": "Boolean",
      ...
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/grid/plugin/RowEditing.js",
      "linenr": 74,
    ...
    },
    {
      ...
      "member": "Ext.grid.plugin.RowEditing",
      "type": "Boolean",
      "doc": "<p><code>true</code> to show a <a href=\"#/api/Ext.tip.ToolTip\" rel=\"Ext.tip.ToolTip\" class=\"docClass\">tooltip</a> that summarizes all validation errors present\nin the row editor. Set to <code>false</code> to prevent the tooltip from showing. Defaults to <code>true</code>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/grid/plugin/RowEditing.js",
      "linenr": 89,
      "html_filename": "RowEditing.html",
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "cancelEdit",
      "member": "Ext.grid.plugin.Editing",
      "doc": "<p>Cancel any active edit that is in progress.</p>\n",
      "params": [
      ...
      "shortDoc": "<p>Cancel any active edit that is in progress.</p>\n"
    },
    {
      "tagname": "method",
      "name": "capture",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.grid.plugin.RowEditing-method-addListener\" rel=\"Ext.grid.plugin.RowEditing-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.plugin.RowEditing-method-addListener\" rel=\"Ext.grid.plugin.RowEditing-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.plugin.RowEditing-method-addListener\" rel=\"Ext.grid.plugin.RowEditing-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.grid.plugin.RowEditing-method-addListener\" rel=\"Ext.grid.plugin.RowEditing-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.plugin.RowEditing--mon\" rel=\"Ext.grid.plugin.RowEditing--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.plugin.RowEditing--mon\" rel=\"Ext.grid.plugin.RowEditing--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.grid.plugin.RowEditing-method-suspendEvents\" rel=\"Ext.grid.plugin.RowEditing-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.plugin.RowEditing-method-resumeEvents\" rel=\"Ext.grid.plugin.RowEditing-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.plugin.RowEditing-method-resumeEvents\" rel=\"Ext.grid.plugin.RowEditing-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.plugin.RowEditing-method-removeListener\" rel=\"Ext.grid.plugin.RowEditing-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.plugin.RowEditing-method-removeListener\" rel=\"Ext.grid.plugin.RowEditing-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
  ...
  "event": [
    {
      ...
      "shortDoc": "Fires before row editing is triggered. The edit event object has the following properties \n\n\ngrid - The grid this edi..."
    },
    {
      "tagname": "event",
      "name": "edit",
      "member": "Ext.grid.plugin.RowEditing",
      "doc": "<p>Fires after a row is edited. The edit event object has the following properties <br /></p>\n\n<ul style=\"padding:5px;padding-left:16px;\">\n<li>grid - The grid this editor is on</li>\n<li>view - The grid view</li>\n<li>store - The grid store</li>\n<li>record - The record being edited</li>\n<li>row - The grid table row</li>\n<li>column - The grid <a href=\"#/api/Ext.grid.column.Column\" rel=\"Ext.grid.column.Column\" class=\"docClass\">Column</a> defining the column that initiated the edit</li>\n<li>rowIdx - The row index that is being edited</li>\n<li>colIdx - The column index that initiated the edit</li>\n</ul>\n\n\n\n\n<pre><code>grid.on('edit', onEdit, this);\n\nfunction onEdit(e) {\n    // execute an XHR to send/commit data to the server, in callback do (if successful):\n    e.record.commit();\n};\n</code></pre>\n\n",
      "params": [
        {
          "type": "Ext.grid.plugin.Editing",
          "name": "editor",
      ...
      "shortDoc": "Fires after a row is edited. The edit event object has the following properties \n\n\ngrid - The grid this editor is on\n..."
    },
    {
      "tagname": "event",
      "name": "validateedit",
