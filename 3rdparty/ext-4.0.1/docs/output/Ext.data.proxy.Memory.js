Ext.data.JsonP.Ext_data_proxy_Memory({
  ...
  "cfg": [
    ...
    },
    {
      "tagname": "cfg",
      "name": "data",
      "member": "Ext.data.proxy.Memory",
      "type": "Array",
      "doc": "<p>Optional array of Records to load into the Proxy</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/proxy/Memory.js",
      "linenr": 61,
  ...
  "method": [
    ...
    },
    {
      ...
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/proxy/Client.js",
      "linenr": 13,
      "html_filename": "Client.html",
      "href": "Client.html#Ext-data-proxy-Client-method-clear",
      "shortDoc": "Abstract function that must be implemented by each ClientProxy subclass. This should purge all record data\nfrom the c..."
    },
    {
      "tagname": "method",
      "name": "clearListeners",
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.data.proxy.Memory-method-enableBubble\" rel=\"Ext.data.proxy.Memory-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.data.proxy.Memory-method-addListener\" rel=\"Ext.data.proxy.Memory-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.proxy.Memory-method-addListener\" rel=\"Ext.data.proxy.Memory-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.proxy.Memory-method-addListener\" rel=\"Ext.data.proxy.Memory-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "read",
      "member": "Ext.data.proxy.Memory",
      "doc": "<p>Reads data from the configured <a href=\"#/api/Ext.data.proxy.Memory-cfg-data\" rel=\"Ext.data.proxy.Memory-cfg-data\" class=\"docClass\">data</a> object. Uses the Proxy's <a href=\"#/api/Ext.data.proxy.Memory--reader\" rel=\"Ext.data.proxy.Memory--reader\" class=\"docClass\">reader</a>, if present</p>\n",
      "params": [
        {
          "type": "Ext.data.Operation",
          "name": "operation",
      ...
      "shortDoc": "<p>Reads data from the configured <a href=\"#/api/Ext.data.proxy.Memory-cfg-data\" rel=\"Ext.data.proxy.Memory-cfg-data\" class=\"docClass\">data</a> object. Uses the Proxy's <a href=\"#/api/Ext.data.proxy.Memory--reader\" rel=\"Ext.data.proxy.Memory--reader\" class=\"docClass\">reader</a>, if present</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.data.proxy.Memory-method-addListener\" rel=\"Ext.data.proxy.Memory-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.proxy.Memory--mon\" rel=\"Ext.data.proxy.Memory--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.proxy.Memory--mon\" rel=\"Ext.data.proxy.Memory--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.data.proxy.Memory-method-suspendEvents\" rel=\"Ext.data.proxy.Memory-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.proxy.Memory-method-resumeEvents\" rel=\"Ext.data.proxy.Memory-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.proxy.Memory-method-resumeEvents\" rel=\"Ext.data.proxy.Memory-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.proxy.Memory-method-removeListener\" rel=\"Ext.data.proxy.Memory-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.proxy.Memory-method-removeListener\" rel=\"Ext.data.proxy.Memory-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "update",
