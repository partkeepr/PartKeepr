Ext.data.JsonP.Ext_view_DropZone({
  "tagname": "class",
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "notifyDrop",
      "member": "Ext.dd.DropZone",
      "doc": "<p>The function a <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> calls once to notify this drop zone that the dragged item has\nbeen dropped on it.  The drag zone will look up the target node based on the event passed in, and if there\nis a node registered for that event, it will delegate to <a href=\"#/api/Ext.view.DropZone-method-onNodeDrop\" rel=\"Ext.view.DropZone-method-onNodeDrop\" class=\"docClass\">onNodeDrop</a> for node-specific handling,\notherwise it will call <a href=\"#/api/Ext.view.DropZone-method-onContainerDrop\" rel=\"Ext.view.DropZone-method-onContainerDrop\" class=\"docClass\">onContainerDrop</a>.</p>\n",
      "params": [
        {
    ...
    },
    {
      ...
      "name": "notifyOver",
      "member": "Ext.dd.DropZone",
      "doc": "<p>The function a <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> calls continuously while it is being dragged over the drop zone.\nThis method will be called on every mouse movement while the drag source is over the drop zone.\nIt will call <a href=\"#/api/Ext.view.DropZone-method-onNodeOver\" rel=\"Ext.view.DropZone-method-onNodeOver\" class=\"docClass\">onNodeOver</a> while the drag source is over a registered node, and will also automatically\ndelegate to the appropriate node-specific methods as necessary when the drag source enters and exits\nregistered nodes (<a href=\"#/api/Ext.view.DropZone-method-onNodeEnter\" rel=\"Ext.view.DropZone-method-onNodeEnter\" class=\"docClass\">onNodeEnter</a>, <a href=\"#/api/Ext.view.DropZone-method-onNodeOut\" rel=\"Ext.view.DropZone-method-onNodeOut\" class=\"docClass\">onNodeOut</a>). If the drag source is not currently over a\nregistered node, it will call <a href=\"#/api/Ext.view.DropZone-method-onContainerOver\" rel=\"Ext.view.DropZone-method-onContainerOver\" class=\"docClass\">onContainerOver</a>.</p>\n",
      "params": [
        {
          "type": "Ext.dd.DragSource",
          "name": "source",
      ...
      "params": [
        {
          "type": "Object",
          "name": "nodeData",
          "doc": "<p>The custom data associated with the drop node (this is the same value returned from\n<a href=\"#/api/Ext.view.DropZone-method-getTargetFromEvent\" rel=\"Ext.view.DropZone-method-getTargetFromEvent\" class=\"docClass\">getTargetFromEvent</a> for this node)</p>\n",
          "optional": false
        },
        {
          "type": "Ext.dd.DragSource",
    ...
    },
    {
      ...
      "name": "onNodeEnter",
      "member": "Ext.dd.DropZone",
      "doc": "<p>Called when the DropZone determines that a <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> has entered a drop node\nthat has either been registered or detected by a configured implementation of <a href=\"#/api/Ext.view.DropZone-method-getTargetFromEvent\" rel=\"Ext.view.DropZone-method-getTargetFromEvent\" class=\"docClass\">getTargetFromEvent</a>.\nThis method has no default implementation and should be overridden to provide\nnode-specific processing if necessary.</p>\n",
      "params": [
        {
          "type": "Object",
          "name": "nodeData",
  ...
  "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/view/DropZone.js",
  "linenr": 1,
  "html_filename": "DropZone3.html",
  "href": "DropZone3.html#Ext-view-DropZone",
  "cssVar": [
