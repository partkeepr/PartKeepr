Ext.data.JsonP.Ext_draw_CompositeSprite({
  ...
  "method": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Removes all items from the collection.  Fires the <a href=\"#/api/Ext.draw.CompositeSprite-event-clear\" rel=\"Ext.draw.CompositeSprite-event-clear\" class=\"docClass\">clear</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "clearListeners",
    ...
    },
    {
      ...
      "name": "hasActiveFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.draw.CompositeSprite-method-getActiveAnimation\" rel=\"Ext.draw.CompositeSprite-method-getActiveAnimation\" class=\"docClass\">getActiveAnimation</a>\nReturns thq current animation if this object has any effects actively running or queued, else returns false.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Inserts an item at the specified index in the collection. Fires the <a href=\"#/api/Ext.draw.CompositeSprite-event-add\" rel=\"Ext.draw.CompositeSprite-event-add\" class=\"docClass\">add</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "last",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.draw.CompositeSprite-method-addListener\" rel=\"Ext.draw.CompositeSprite-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.draw.CompositeSprite-method-addListener\" rel=\"Ext.draw.CompositeSprite-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.draw.CompositeSprite-method-addListener\" rel=\"Ext.draw.CompositeSprite-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "shortDoc": "<p>Remove an item from a specified index in the collection. Fires the <a href=\"#/api/Ext.draw.CompositeSprite-event-remove\" rel=\"Ext.draw.CompositeSprite-event-remove\" class=\"docClass\">remove</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "removeAtKey",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.draw.CompositeSprite-method-addListener\" rel=\"Ext.draw.CompositeSprite-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.draw.CompositeSprite--mon\" rel=\"Ext.draw.CompositeSprite--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.draw.CompositeSprite--mon\" rel=\"Ext.draw.CompositeSprite--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "reorder",
    ...
    },
    {
      ...
      "shortDoc": "<p>Replaces an item in the collection. Fires the <a href=\"#/api/Ext.draw.CompositeSprite-event-replace\" rel=\"Ext.draw.CompositeSprite-event-replace\" class=\"docClass\">replace</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.draw.CompositeSprite-method-suspendEvents\" rel=\"Ext.draw.CompositeSprite-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "stopFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.draw.CompositeSprite-method-stopAnimation\" rel=\"Ext.draw.CompositeSprite-method-stopAnimation\" class=\"docClass\">stopAnimation</a>\nStops any running effects and clears this object's internal effects queue if it contains\nany additional effects that haven't started yet.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.draw.CompositeSprite-method-resumeEvents\" rel=\"Ext.draw.CompositeSprite-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.draw.CompositeSprite-method-resumeEvents\" rel=\"Ext.draw.CompositeSprite-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "syncFx",
    ...
    },
    {
      ...
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.draw.CompositeSprite-method-removeListener\" rel=\"Ext.draw.CompositeSprite-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.draw.CompositeSprite-method-removeListener\" rel=\"Ext.draw.CompositeSprite-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
