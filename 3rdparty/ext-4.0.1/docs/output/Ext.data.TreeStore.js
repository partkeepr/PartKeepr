Ext.data.JsonP.Ext_data_TreeStore({
  ...
  "cfg": [
    ...
    },
    {
      ...
      "type": "Boolean",
      "doc": "<p>(optional) Default to true. Remove previously existing\nchild nodes before loading.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/TreeStore.js",
      "linenr": 25,
    ...
    },
    {
      ...
      "member": "Ext.data.TreeStore",
      "type": "Boolean",
      "doc": "<p>Set to true to automatically prepend a leaf sorter (defaults to <tt>undefined</tt>)</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/TreeStore.js",
      "linenr": 49,
      "html_filename": "TreeStore.html",
    ...
    },
    {
      ...
      "member": "Ext.data.TreeStore",
      "type": "String",
      "doc": "<p>The name of the parameter sent to the server which contains\nthe identifier of the node. Defaults to <tt>'node'</tt>.</p>\n",
      "private": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/TreeStore.js",
      "linenr": 31,
      "html_filename": "TreeStore.html",
  ...
  "method": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Returns the record node by id</p>\n"
    },
    {
      "tagname": "method",
      "name": "getProxy",
    ...
    },
    {
      ...
      "shortDoc": "<p>Loads the Store using its configured <a href=\"#/api/Ext.data.TreeStore-cfg-proxy\" rel=\"Ext.data.TreeStore-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "observe",
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.TreeStore-method-addListener\" rel=\"Ext.data.TreeStore-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.data.TreeStore-method-addListener\" rel=\"Ext.data.TreeStore-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.data.TreeStore-method-addListener\" rel=\"Ext.data.TreeStore-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.TreeStore--mon\" rel=\"Ext.data.TreeStore--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.data.TreeStore--mon\" rel=\"Ext.data.TreeStore--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.data.TreeStore-method-suspendEvents\" rel=\"Ext.data.TreeStore-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "setRootNode",
      "member": "Ext.data.TreeStore",
      "doc": "<p>Sets the root node for this store</p>\n",
      "params": [
        {
          "type": "Ext.data.Model/Ext.data.NodeInterface",
          "name": "root",
          "doc": "\n",
          "optional": false
        }
      ...
      "shortDoc": "<p>Sets the root node for this store</p>\n"
    },
    {
      "tagname": "method",
      "name": "sort",
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.TreeStore-method-resumeEvents\" rel=\"Ext.data.TreeStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.data.TreeStore-method-resumeEvents\" rel=\"Ext.data.TreeStore-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "sync",
    ...
    },
    {
      ...
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.TreeStore-method-removeListener\" rel=\"Ext.data.TreeStore-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.data.TreeStore-method-removeListener\" rel=\"Ext.data.TreeStore-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
    ...
    },
    {
      ...
      "member": "Ext.data.AbstractStore",
      "type": "Boolean",
      "doc": "<p>True if the Store has already been destroyed via <a href=\"#/api/Ext.data.TreeStore--destroyStore\" rel=\"Ext.data.TreeStore--destroyStore\" class=\"docClass\">destroyStore</a>. If this is true, the reference to Store should be deleted\nas it will not function correctly any more.</p>\n",
      "private": false,
      "static": false,
      "filename": "/Users/nick/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
      "linenr": 111,
  ...
  "event": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires when a new child node is appended to a node in this store's tree.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeappend",
      ...
      "shortDoc": "<p>Fires before a new child is appended to a node in this store's tree, return false to cancel the append.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforecollapse",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before a new child is inserted in a node in this store's tree, return false to cancel the insert.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeload",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before a node is moved to a new location in the store's tree. Return false to cancel the move.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeremove",
      ...
      "shortDoc": "<p>Fires before a child is removed from a node in this store's tree, return false to cancel the remove.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforesync",
      ...
      "shortDoc": "<p>Called before a call to <a href=\"#/api/Ext.data.TreeStore-method-sync\" rel=\"Ext.data.TreeStore-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n"
    },
    {
      "tagname": "event",
      "name": "clear",
      ...
      "shortDoc": "<p>Fired after the <a href=\"#/api/Ext.data.TreeStore-method-removeAll\" rel=\"Ext.data.TreeStore-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n"
    },
    {
      "tagname": "event",
      "name": "collapse",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires when a new child node is inserted in a node in this store's tree.</p>\n"
    },
    {
      "tagname": "event",
      "name": "load",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires when a node is moved to a new location in the store's tree</p>\n"
    },
    {
      "tagname": "event",
      "name": "remove",
      ...
      "shortDoc": "<p>Fires when a child node is removed from a node in this store's tree.</p>\n"
    },
    {
      "tagname": "event",
      "name": "rootchange",
      ...
      "shortDoc": "<p>Fires when the root node on this TreeStore is changed.</p>\n"
    },
    {
      "tagname": "event",
      "name": "sort",
      ...
      "shortDoc": "<p>Fires when this TreeStore is sorted.</p>\n"
    },
    {
      "tagname": "event",
      "name": "update",
