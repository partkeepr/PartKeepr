Ext.data.JsonP.Ext_grid_header_Container({
  ...
  "method": [
    ...
    },
    {
      ...
      "name": "addClass",
      "member": "Ext.AbstractComponent",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.header.Container-method-addCls\" rel=\"Ext.grid.header.Container-method-addCls\" class=\"docClass\">addCls</a>\nAdds a CSS class to the top level element representing this component.</p>\n",
      "params": [
        {
          "type": "String",
          "name": "cls",
      ...
      "shortDoc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.header.Container-method-addCls\" rel=\"Ext.grid.header.Container-method-addCls\" class=\"docClass\">addCls</a>\nAdds a CSS class to the top level element representing this component.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addCls",
    ...
    },
    {
      ...
      "name": "addClsWithUI",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.header.Container--addUIClsToElement\" rel=\"Ext.grid.header.Container--addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
      ...
      "shortDoc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.header.Container--addUIClsToElement\" rel=\"Ext.grid.header.Container--addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addEvents",
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.grid.header.Container-method-enableBubble\" rel=\"Ext.grid.header.Container-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "shortDoc": "<p>Examines this container's <code><a href=\"#/api/Ext.grid.header.Container-property-items\" rel=\"Ext.grid.header.Container-property-items\" class=\"docClass\">items</a></code> <b>property</b>\nand gets a direct child component of this container.</p>\n"
    },
    {
      "tagname": "method",
      "name": "getEl",
    ...
    },
    {
      ...
      "name": "hasActiveFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.header.Container-method-getActiveAnimation\" rel=\"Ext.grid.header.Container-method-getActiveAnimation\" class=\"docClass\">getActiveAnimation</a>\nReturns thq current animation if this object has any effects actively running or queued, else returns false.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.grid.header.Container-cfg-hideMode\" rel=\"Ext.grid.header.Container-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n"
    },
    {
      "tagname": "method",
      "name": "insert",
    ...
    },
    {
      ...
      "name": "nextNode",
      "member": "Ext.AbstractComponent",
      "doc": "<p>Returns the next node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree to attempt to find a match. Contrast with <a href=\"#/api/Ext.grid.header.Container--pnextSibling\" rel=\"Ext.grid.header.Container--pnextSibling\" class=\"docClass\">pnextSibling</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "selector",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.grid.header.Container-method-addListener\" rel=\"Ext.grid.header.Container-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.header.Container-method-addListener\" rel=\"Ext.grid.header.Container-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.grid.header.Container-method-addListener\" rel=\"Ext.grid.header.Container-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "prepareData",
    ...
    },
    {
      ...
      "member": "Ext.AbstractComponent",
      "doc": "<p>Removes a cls to the uiCls array, which will also call <a href=\"#/api/Ext.grid.header.Container--removeUIClsToElement\" rel=\"Ext.grid.header.Container--removeUIClsToElement\" class=\"docClass\">removeUIClsToElement</a> and removes\nit from all elements of this component.</p>\n",
      "params": [
        {
          "type": "String/Array",
          "name": "cls",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.grid.header.Container-method-addListener\" rel=\"Ext.grid.header.Container-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.header.Container--mon\" rel=\"Ext.grid.header.Container--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.header.Container--mon\" rel=\"Ext.grid.header.Container--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.grid.header.Container-method-suspendEvents\" rel=\"Ext.grid.header.Container-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.grid.header.Container-event-resize\" rel=\"Ext.grid.header.Container-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "setLoading",
    ...
    },
    {
      ...
      "shortDoc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.grid.header.Container-event-resize\" rel=\"Ext.grid.header.Container-event-resize\" class=\"docClass\">resize</a> event.</p>\n"
    },
    {
      "tagname": "method",
      "name": "show",
      "member": "Ext.Component",
      "doc": "<p>Shows this Component, rendering it first if <a href=\"#/api/Ext.grid.header.Container-cfg-autoRender\" rel=\"Ext.grid.header.Container-cfg-autoRender\" class=\"docClass\">autoRender</a> or {<a href=\"#/api/\"floating\" rel=\"\"floating\" class=\"docClass\">&quot;floating</a> are <code>true</code>.</p>\n\n\n<p>After being shown, a <a href=\"#/api/Ext.grid.header.Container-cfg-floating\" rel=\"Ext.grid.header.Container-cfg-floating\" class=\"docClass\">floating</a> Component (such as a <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Ext.window.Window</a>), is activated it and brought to the front of\nits <a href=\"#/api/Ext.grid.header.Container--ZIndexManager\" rel=\"Ext.grid.header.Container--ZIndexManager\" class=\"docClass\">z-index stack</a>.</p>\n\n",
      "params": [
        {
          "type": "String/Element",
          "name": "animateTarget",
    ...
    },
    {
      ...
      "name": "stopFx",
      "member": "Ext.util.Animate",
      "doc": "<p>@deprecated 4.0 Replaced by <a href=\"#/api/Ext.grid.header.Container-method-stopAnimation\" rel=\"Ext.grid.header.Container-method-stopAnimation\" class=\"docClass\">stopAnimation</a>\nStops any running effects and clears this object's internal effects queue if it contains\nany additional effects that haven't started yet.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.header.Container-method-resumeEvents\" rel=\"Ext.grid.header.Container-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.grid.header.Container-method-resumeEvents\" rel=\"Ext.grid.header.Container-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "syncFx",
    ...
    },
    {
      ...
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.header.Container-method-removeListener\" rel=\"Ext.grid.header.Container-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.grid.header.Container-method-removeListener\" rel=\"Ext.grid.header.Container-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "up",
  ...
  "event": [
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.header.Container-event-destroy\" rel=\"Ext.grid.header.Container-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.grid.header.Container-event-destroy\" rel=\"Ext.grid.header.Container-event-destroy\" class=\"docClass\">destroy</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforehide",
      ...
      "shortDoc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.grid.header.Container-event-hide\" rel=\"Ext.grid.header.Container-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeremove",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.header.Container-property-rendered\" rel=\"Ext.grid.header.Container-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.grid.header.Container-event-render\" rel=\"Ext.grid.header.Container-event-render\" class=\"docClass\">render</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "beforeshow",
      ...
      "shortDoc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.grid.header.Container-event-show\" rel=\"Ext.grid.header.Container-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
    },
    {
      "tagname": "event",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component is <a href=\"#/api/Ext.grid.header.Container-event-destroy\" rel=\"Ext.grid.header.Container-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
    },
    {
      "tagname": "event",
      "name": "disable",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component markup is <a href=\"#/api/Ext.grid.header.Container-property-rendered\" rel=\"Ext.grid.header.Container-property-rendered\" class=\"docClass\">rendered</a>.</p>\n"
    },
    {
      "tagname": "event",
      "name": "resize",
    ...
    },
    {
      ...
      "shortDoc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.grid.header.Container-event-show\" rel=\"Ext.grid.header.Container-event-show\" class=\"docClass\">show</a> method.</p>\n"
    },
    {
      "tagname": "event",
      "name": "sortchange",
