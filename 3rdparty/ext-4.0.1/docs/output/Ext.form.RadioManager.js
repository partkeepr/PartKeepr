Ext.data.JsonP.Ext_form_RadioManager({
  "tagname": "class",
  "name": "Ext.form.RadioManager",
  "doc": "<p>Private utility class for managing all <a href=\"#/api/Ext.form.field.Radio\" rel=\"Ext.form.field.Radio\" class=\"docClass\">Ext.form.field.Radio</a> fields grouped by name.</p>\n",
  ...
  "cfg": [
    {
      ...
      "type": "Boolean",
      "doc": "<p>Specify <tt>true</tt> if the <a href=\"#/api/Ext.form.RadioManager-method-addAll\" rel=\"Ext.form.RadioManager-method-addAll\" class=\"docClass\">addAll</a>\nfunction should add function references to the collection. Defaults to\n<tt>false</tt>.</p>\n",
      "private": false,
  ...
  "method": [
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "keyFn",
          "doc": "<p>A function that can accept an item of the type(s) stored in this MixedCollection\nand return the key value for that item.  This is used when available to look up the key on items that\nwere passed without an explicit key parameter to a MixedCollection method.  Passing this parameter is\nequivalent to providing an implementation for the <a href=\"#/api/Ext.form.RadioManager-method-getKey\" rel=\"Ext.form.RadioManager-method-getKey\" class=\"docClass\">getKey</a> method.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "add",
      "member": "Ext.util.AbstractMixedCollection",
      "doc": "<p>Adds an item to the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-add\" rel=\"Ext.form.RadioManager-event-add\" class=\"docClass\">add</a> event when complete.</p>\n",
      "params": [
        {
          "type": "String",
          "name": "key",
          "doc": "<p>The key to associate with the item, or the new item.</p>\n\n\n<p>If a <a href=\"#/api/Ext.form.RadioManager-method-getKey\" rel=\"Ext.form.RadioManager-method-getKey\" class=\"docClass\">getKey</a> implementation was specified for this MixedCollection,\nor if the key of the stored items is in a property called <tt><b>id</b></tt>,\nthe MixedCollection will be able to <i>derive</i> the key for the new item.\nIn this case just pass the new item in this parameter.</p>\n\n",
          "optional": false
        },
        {
          "type": "Object",
      ...
      "shortDoc": "<p>Adds an item to the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-add\" rel=\"Ext.form.RadioManager-event-add\" class=\"docClass\">add</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "addAll",
      ...
      "params": [
        {
          "type": "Object/Array",
          "name": "objs",
          "doc": "<p>An Object containing properties which will be added\nto the collection, or an Array of values, each of which are added to the collection.\nFunctions references will be added to the collection if <code><a href=\"#/api/Ext.form.RadioManager-cfg-allowFunctions\" rel=\"Ext.form.RadioManager-cfg-allowFunctions\" class=\"docClass\">allowFunctions</a></code>\nhas been set to <tt>true</tt>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "clear",
      "member": "Ext.util.AbstractMixedCollection",
      "doc": "<p>Removes all items from the collection.  Fires the <a href=\"#/api/Ext.form.RadioManager-event-clear\" rel=\"Ext.form.RadioManager-event-clear\" class=\"docClass\">clear</a> event when complete.</p>\n",
      "params": [
      ...
      "shortDoc": "<p>Removes all items from the collection.  Fires the <a href=\"#/api/Ext.form.RadioManager-event-clear\" rel=\"Ext.form.RadioManager-event-clear\" class=\"docClass\">clear</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "clearListeners",
    ...
    },
    {
      ...
      "name": "fireEvent",
      "member": "Ext.util.Observable",
      "doc": "<p>Fires the specified event with the passed parameters (minus the event name).</p>\n\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>)\nby calling <a href=\"#/api/Ext.form.RadioManager-method-enableBubble\" rel=\"Ext.form.RadioManager-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
    ...
    },
    {
      ...
      "name": "get",
      "member": "Ext.util.AbstractMixedCollection",
      "doc": "<p>Returns the item associated with the passed key OR index.\nKey has priority over index.  This is the equivalent\nof calling <a href=\"#/api/Ext.form.RadioManager--key\" rel=\"Ext.form.RadioManager--key\" class=\"docClass\">key</a> first, then if nothing matched calling <a href=\"#/api/Ext.form.RadioManager-method-getAt\" rel=\"Ext.form.RadioManager-method-getAt\" class=\"docClass\">getAt</a>.</p>\n",
      "params": [
        {
          "type": "String/Number",
          "name": "key",
    ...
    },
    {
      ...
      "name": "insert",
      "member": "Ext.util.AbstractMixedCollection",
      "doc": "<p>Inserts an item at the specified index in the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-add\" rel=\"Ext.form.RadioManager-event-add\" class=\"docClass\">add</a> event when complete.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "index",
      ...
      "shortDoc": "<p>Inserts an item at the specified index in the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-add\" rel=\"Ext.form.RadioManager-event-add\" class=\"docClass\">add</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "last",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Object",
          "name": "listeners",
          "doc": "<p>An object containing a series of listeners to add. See <a href=\"#/api/Ext.form.RadioManager-method-addListener\" rel=\"Ext.form.RadioManager-method-addListener\" class=\"docClass\">addListener</a>.</p>\n",
          "optional": false
        }
      ],
      "return": {
    ...
    },
    {
      ...
      "name": "on",
      "member": "Ext.util.Observable",
      "doc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.form.RadioManager-method-addListener\" rel=\"Ext.form.RadioManager-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Appends an event handler to this object (shorthand for <a href=\"#/api/Ext.form.RadioManager-method-addListener\" rel=\"Ext.form.RadioManager-method-addListener\" class=\"docClass\">addListener</a>.)</p>\n"
    },
    {
      "tagname": "method",
      "name": "relayEvents",
    ...
    },
    {
      ...
      "name": "removeAt",
      "member": "Ext.util.AbstractMixedCollection",
      "doc": "<p>Remove an item from a specified index in the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-remove\" rel=\"Ext.form.RadioManager-event-remove\" class=\"docClass\">remove</a> event when complete.</p>\n",
      "params": [
        {
          "type": "Number",
          "name": "index",
      ...
      "shortDoc": "<p>Remove an item from a specified index in the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-remove\" rel=\"Ext.form.RadioManager-event-remove\" class=\"docClass\">remove</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "removeAtKey",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          "type": "Function",
          "name": "handler",
          "doc": "<p>The handler to remove. <b>This must be a reference to the function passed into the <a href=\"#/api/Ext.form.RadioManager-method-addListener\" rel=\"Ext.form.RadioManager-method-addListener\" class=\"docClass\">addListener</a> call.</b></p>\n",
          "optional": false
        },
        {
          "type": "Object",
    ...
    },
    {
      ...
      "member": "Ext.util.Observable",
      "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.form.RadioManager--mon\" rel=\"Ext.form.RadioManager--mon\" class=\"docClass\">mon</a> method.</p>\n",
      "params": [
        {
          "type": "Observable|Element",
          "name": "item",
      ...
      "shortDoc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.form.RadioManager--mon\" rel=\"Ext.form.RadioManager--mon\" class=\"docClass\">mon</a> method.</p>\n"
    },
    {
      "tagname": "method",
      "name": "reorder",
    ...
    },
    {
      ...
      "name": "replace",
      "member": "Ext.util.AbstractMixedCollection",
      "doc": "<p>Replaces an item in the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-replace\" rel=\"Ext.form.RadioManager-event-replace\" class=\"docClass\">replace</a> event when complete.</p>\n",
      "params": [
        {
          "type": "String",
          "name": "key",
          "doc": "<p>The key associated with the item to replace, or the replacement item.</p>\n\n\n<p>If you supplied a <a href=\"#/api/Ext.form.RadioManager-method-getKey\" rel=\"Ext.form.RadioManager-method-getKey\" class=\"docClass\">getKey</a> implementation for this MixedCollection, or if the key\nof your stored items is in a property called <tt><b>id</b></tt>, then the MixedCollection\nwill be able to <i>derive</i> the key of the replacement item. If you want to replace an item\nwith one having the same key value, then just pass the replacement item in this parameter.</p>\n\n",
          "optional": false
        },
        {
          "type": "Object",
      ...
      "shortDoc": "<p>Replaces an item in the collection. Fires the <a href=\"#/api/Ext.form.RadioManager-event-replace\" rel=\"Ext.form.RadioManager-event-replace\" class=\"docClass\">replace</a> event when complete.</p>\n"
    },
    {
      "tagname": "method",
      "name": "resumeEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Resume firing events. (see <a href=\"#/api/Ext.form.RadioManager-method-suspendEvents\" rel=\"Ext.form.RadioManager-method-suspendEvents\" class=\"docClass\">suspendEvents</a>)\nIf events were suspended using the <code><b>queueSuspended</b></code> parameter, then all\nevents fired during event suspension will be sent to any listeners now.</p>\n",
      "params": [
    ...
    },
    {
      ...
      "name": "suspendEvents",
      "member": "Ext.util.Observable",
      "doc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.form.RadioManager-method-resumeEvents\" rel=\"Ext.form.RadioManager-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
      "params": [
        {
          "type": "Boolean",
          "name": "queueSuspended",
          "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.form.RadioManager-method-resumeEvents\" rel=\"Ext.form.RadioManager-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events;</p>\n",
          "optional": false
        }
      ],
      "return": {
      ...
      "shortDoc": "<p>Suspend the firing of all events. (see <a href=\"#/api/Ext.form.RadioManager-method-resumeEvents\" rel=\"Ext.form.RadioManager-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n"
    },
    {
      "tagname": "method",
      "name": "un",
      "member": "Ext.util.Observable",
      "doc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.form.RadioManager-method-removeListener\" rel=\"Ext.form.RadioManager-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n",
      "params": [
        {
          "type": "String",
          "name": "eventName",
      ...
      "shortDoc": "<p>Removes an event handler (shorthand for <a href=\"#/api/Ext.form.RadioManager-method-removeListener\" rel=\"Ext.form.RadioManager-method-removeListener\" class=\"docClass\">removeListener</a>.)</p>\n"
    }
  ],
  "property": [
    {
  ...
  "filename": "/Users/nick/Projects/sencha/SDK/extjs/src/form/RadioManager.js",
  "linenr": 1,
  "html_filename": "RadioManager.html",
  "href": "RadioManager.html#Ext-form-RadioManager",
  "cssVar": [
